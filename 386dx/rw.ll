; .Titre "Gestion des fichiers "comme en C" (pour faire de l'acces direct)
; .Date "05/17/93"
; .Auteur "Cyril Cambien
; .Modification : 09/08/92 Gestion du cload et des pathnames. (G.Schumacher)
