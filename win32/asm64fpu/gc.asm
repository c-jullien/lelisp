...
gcinfon9	label	near
	...
	mov	edx,dword ptr [bfloat]
	cmp	dword ptr [bfloat],edx
	ja	near ptr gcinfof9
	cmp	dword ptr [bvect],edx
	jbe	near ptr gcinfof9
gcinfof1	label	near
	inc	ebx
	cmp	ebx,1024
	jl	short mac1163
