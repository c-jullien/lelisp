...
cfadd	proc	near
	...
	fstp	dword ptr [farg2]
	fwait
	shr	dword ptr [farg2],1
	or	dword ptr [farg2],80000000h
	ret
cfsub	label	near
	mov	ebp,dword ptr [farg1]
	mov	dword ptr [_accusingle2],ebp
...
extv3	label	near
	...
	dec	edi
mac323:
	shr	dword ptr [esi+edi*4],1
	or	dword ptr [esi+edi*4],80000000h
	dec	edi
	jns	short mac323
	jmp	near ptr extv1
extv4	label	near
...
ll_conv2	label	near
	...
	mov	dword ptr [_accusingle1],esi
	shl	dword ptr [_accusingle1],1
	fld	dword ptr [_accusingle1]
	fstp	qword ptr [_accusingle2]
	mov	edi,dword ptr [_accusingle2]
	sub	eax,4
...
ll_buil2	label	near
	...
	fstp	dword ptr [_accusingle1]
	fwait
	mov	ebp,dword ptr [_accusingle1]
	shr	ebp,1
	or	ebp,80000000h
	ret
ll_buil3	label	near
	...
	mov	ebx,edi
	mov	eax,0
	jmp	near ptr ll_buil1__1
ll_buil__1:
	inc	ax
ll_buil1__1:
	cmp	byte ptr [edi+eax*1],0
	jne	near ptr ll_buil__1
	push	eax
	push	edi
	mov	edi,_bcons
	mov	esi,_bsymb
...
getsym2	label	near
	...
	mov	ebx,edi
	mov	eax,0
	jmp	near ptr ll_buil1__2
ll_buil__2:
	inc	ax
ll_buil1__2:
	cmp	byte ptr [edi+eax*1],0
	jne	near ptr ll_buil__2
	push	eax
	push	edi
	mov	edi,_bcons
	mov	esi,_bsymb
