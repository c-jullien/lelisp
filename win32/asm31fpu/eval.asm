...
evexpg	label	near
	mov	eax,dword ptr [4+eax]
	cmp	eax,edi
	jl	near ptr evprogn7
	mov	ebx,dword ptr [4+eax]
	cmp	ebx,edi
	jge	near ptr evprogn2
	cmp	ebx,esi
...
unbid12	label	near
	...
	mov	ecx,dword ptr [4+ecx]
	cmp	ebx,edi
	jge	near ptr unbid19
	dec	dx
	mov	ebp,dword ptr [esp+edx*4]
	mov	dword ptr [ebx],ebp
unbid15	label	near
	cmp	ecx,edi
	jge	near ptr unbid12
	cmp	ecx,esi
	je	near ptr unbid18
	cmp	ecx,dword ptr [znobind]
	je	near ptr unbid18
