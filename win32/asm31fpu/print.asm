...
ini_print	proc	near
	...
	mov	eax,14
	mov	ebx,offset FLAT:pnmac572
	mov	ecx,offset FLAT:zstatpr
	call	near ptr inicst
	mov	dword ptr [eax],esi
	mov	eax,15
	mov	ebx,offset FLAT:pnmac573
	mov	ecx,offset FLAT:zstatpc
	call	near ptr inicst
	mov	dword ptr [eax],esi
	mov	eax,18
	mov	ebx,offset FLAT:pnmac574
