...
tagbdr2	label	near
	...
	cmp	ebx,edi
	jge	near ptr tagbdr3
	push	ecx
	push	ebx
	inc	dx
tagbdr3	label	near
	cmp	ecx,edi
	jge	near ptr tagbdr2
	push	edx
	xor	ebx,ebx
	cmp	dword ptr [fcons],edi
	jb	near ptr l__15
