...
static Ptr GLcarcdr_1(void) {	/* startmodule */
   {	register Ptr aRet;
	{aRet = ((Ptr) GXini_cad); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_cad(void) {	/* ini_cad */
   {	register Ptr aRet;
...
static Ptr GLcarcdr_2(void) {	/* carerr */
   {	register Ptr aRet;
...
static Ptr GLcarcdr_3(void) {	/* caaar1 */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	if ((long) rA1 < (long) rBcons)	{aRet = ((Ptr) GLcarcdr_2); goto lRet;}
	rA1 = rA1->Val;
...
static Ptr GLcarcdr_4(void) {	/* caadr1 */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	if ((long) rA1 < (long) rBcons)	{aRet = ((Ptr) GLcarcdr_2); goto lRet;}
	rA1 = (rA1 + 1)->Val;
...
static Ptr GLcarcdr_5(void) {	/* cadar1 */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	if ((long) rA1 < (long) rBcons)	{aRet = ((Ptr) GLcarcdr_2); goto lRet;}
	rA1 = rA1->Val;
...
static Ptr GLcarcdr_6(void) {	/* cdaar1 */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	if ((long) rA1 < (long) rBcons)	{aRet = ((Ptr) GLcarcdr_2); goto lRet;}
	rA1 = rA1->Val;
...
static Ptr GLcarcdr_7(void) {	/* cdadr1 */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	if ((long) rA1 < (long) rBcons)	{aRet = ((Ptr) GLcarcdr_2); goto lRet;}
	rA1 = (rA1 + 1)->Val;
...
static Ptr GLcarcdr_8(void) {	/* cddar1 */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	if ((long) rA1 < (long) rBcons)	{aRet = ((Ptr) GLcarcdr_2); goto lRet;}
	rA1 = rA1->Val;
...
static Ptr GLcarcdr_9(void) {	/* cdddr1 */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	if ((long) rA1 < (long) rBcons)	{aRet = ((Ptr) GLcarcdr_2); goto lRet;}
	rA1 = (rA1 + 1)->Val;
...
extern Ptr GXcaaaar(void) {	/* caaaar */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcaaaar;
	GIa3 = rA1;
...
extern Ptr GXcaaadr(void) {	/* caaadr */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcaaadr;
	GIa3 = rA1;
...
extern Ptr GXcaadar(void) {	/* caadar */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcaadar;
	GIa3 = rA1;
...
extern Ptr GXcaaddr(void) {	/* caaddr */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcaaddr;
	GIa3 = rA1;
...
extern Ptr GXcadaar(void) {	/* cadaar */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcadaar;
	GIa3 = rA1;
...
extern Ptr GXcadadr(void) {	/* cadadr */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcadadr;
	GIa3 = rA1;
...
extern Ptr GXcaddar(void) {	/* caddar */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	GIa2 = GMcaddar;
	GIa3 = rA1;
...
extern Ptr GXcadddr(void) {	/* cadddr */
   {	register Ptr aRet, rA1, rBcons;
	rA1 = GIa1; rBcons = GIbcons;
	GIa2 = GMcadddr;
	GIa3 = rA1;
...
extern Ptr GXcdaaar(void) {	/* cdaaar */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcdaaar;
	GIa3 = rA1;
...
extern Ptr GXcdaadr(void) {	/* cdaadr */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcdaadr;
	GIa3 = rA1;
...
extern Ptr GXcdadar(void) {	/* cdadar */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcdadar;
	GIa3 = rA1;
...
extern Ptr GXcdaddr(void) {	/* cdaddr */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcdaddr;
	GIa3 = rA1;
...
extern Ptr GXcddaar(void) {	/* cddaar */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcddaar;
	GIa3 = rA1;
...
extern Ptr GXcddadr(void) {	/* cddadr */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcddadr;
	GIa3 = rA1;
...
extern Ptr GXcdddar(void) {	/* cdddar */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcdddar;
	GIa3 = rA1;
...
extern Ptr GXcddddr(void) {	/* cddddr */
   {	register Ptr aRet, rA1;
	rA1 = GIa1;
	GIa2 = GMcddddr;
	GIa3 = rA1;
