...
\SuperTitle {Le-Lisp version 15.25.3
\footnote {Cette note tient lieu de compte rendu de la r\'{e}union du
25/8/93 en ce qui concerne la 15.25.3, en pr\'{e}sence de Alain R.,
Bernard, Bounty, Pom., Jean, Fran\c{c}ois, J\'{e}r\^{o}me, Pascal, Patrick,
Pierre P.,Vincent}
}
...
\Section {Interventions sur le code Le-Lisp }
...
\Section {GELL}
Le g\'{e}n\'{e}rateur de code GELL a \'{e}t\'{e} profond\'{e}ment remani\'{e} afin
