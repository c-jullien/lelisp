...
llfloatr:	l	0,0(1)
	...
	mtlr	0
	br	
llfloatf:	cmpl	0,14,18
	blt	.num.12
	cmpl	0,14,19
	blt	llfloatr
.num.12:	cal	16,18400(21)
	b	bangen1
	.set	._lltrunc,2
	.globl	C.lltrunc
C.lltrunc:	mflr	0
...
gadneg:	lil	14,0
	...
	cmpl	0,15,19
	blt	gadneg3
.num.32:gadneg1:	cal	16,18624(21)
	oril	14,15,0
	b	bangen1
gadneg2:	exts	3,15
	exts	4,14
...
.num.37:	exts	3,15
	...
	stfd	1,0(15)
	b	gadiffp5
gadiffp4:	cmpl	0,15,18
	blt	gadiffp0
	cmpl	0,15,19
	bge	gadiffp0
gadiffp5:	l	5,1172(13)
	cmpli	0,5,0
	bne	.num.38
	.globl	C.gcfloat
	bl	C.gcfloat
