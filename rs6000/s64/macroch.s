...
.mac.3:	l	3,4(6)
	...
	mtlr	0
	br	
commain1:	cal	14,8320(21)
	b	commain0
commain2:	cal	14,8352(21)
	b	commain0
	.set	._llbquote,1
	.globl	C.llbquote
C.llbquote:	mflr	0
...
shrpcol1:	st	21,1456(13)
	...
	bl	C.rereada4
	b	shrpcol3
shrpcol2:	st	14,1456(13)
	.globl	C.readi
	bl	C.readi
shrpcol3:	l	6,1188(13)
	cmpl	0,6,21
	bne	.mac.20
	.globl	C.gccons
	bl	C.gccons
...
C.lllbra:	mflr	0
	stu	0,-4(1)
	.globl	lllbra
lllbra:	cal	14,8160(21)
lllbra1:	cal	15,7168(21)
	b	errudf
	.set	._llrbra,1
	.globl	C.llrbra
C.llrbra:	mflr	0
...
typechg1:	l	14,0(1)
	...
	bge	typechr2
	b	typechg7
typechg5:	st	15,1744(13)
	.globl	C.stringa1
	bl	C.stringa1
	l	3,0(14)
	lbz	14,8(3)
typechg7:	l	3,1400(13)
	l	3,0(3)
	ai	4,14,8
	lbzx	14,3,4
	l	3,1640(13)
