...
lleof:	cmpl	0,14,21
	...
	l	14,0(1)
	ai	1,1,4
lleof1:	cal	15,7136(21)
	l	3,0(15)
	cmpl	0,3,21
	beq	lleof2
	b	erlec11
lleof2:	cal	15,6272(21)
	b	findtag
	.set	._prompt,5
	.globl	C.prompt
C.prompt:	mflr	0
...
prompt1:	l	14,0(1)
	...
	bl	C.stringa1
	st	14,1364(13)
prompt2:	l	14,1364(13)
	l	0,0(1)
	ai	1,1,4
	mtlr	0
	br	
prompter:	cal	15,6304(21)
	b	errnaa
	.set	._coercns,2
	.globl	C.coercns
C.coercns:	mflr	0
...
C.inclose:	mflr	0
	stu	0,-4(1)
inclose:	l	15,1328(13)
	cmpl	0,15,21
	bne	inchani1
	l	15,1212(13)
	ai	4,15,1
	andil.	15,4,0xFFFF
inchani1:	l	3,1336(13)
	l	3,0(3)
	ai	4,15,2
	sli	4,4,2
	lx	15,3,4
...
C.outopen:	mflr	0
	stu	0,-4(1)
outopen:	st	14,1332(13)
outchai3:	oril	15,14,0
outchai4:	l	3,1336(13)
	l	3,0(3)
	ai	4,15,2
	sli	4,4,2
	lx	15,3,4
...
C.outclose:	mflr	0
	stu	0,-4(1)
outclose:	l	15,1332(13)
outchai1:	l	3,1336(13)
	l	3,0(3)
	ai	4,15,2
	sli	4,4,2
	lx	15,3,4
...
closer0:	xor	14,14,14
	oril	14,14,0xFFFC
	b	closer3
closer1:	cal	15,6784(21)
	lil	14,1
	b	errwna
closer2:	xor	14,14,14
	oril	14,14,0xFFFD
closer3:	cal	15,6784(21)
	b	errios
closer4:	cal	15,6784(21)
	b	errnia
	.globl	C.closeint
C.closeint:	mflr	0
	stu	0,-4(1)
