...
/* Last modified_on Tue Jun  6 13:37:21 GMT+2:00 1989 by shand */
/*      modified_on Fri Apr 28 18:36:19 GMT+2:00 1989 by herve */
...
{ 
    ...
    {
        register BigNumDigit save, Lm, Hm, Ld, Hd, X0, X1, X2, X3;
...

{
    ...
    else
    {
        ...
        if (k != 0 && orig_qq != orig_nn + 1) 
            BnnShiftRight (orig_nn, orig_nl, k);    
