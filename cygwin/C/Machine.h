...
/*                                                      */
/* $Id: Machine.h,v 1.7 2017/07/30 13:26:50 jullien Exp $ */
/********************************************************/
...
/* # ITINREAD scan char while reading */
#define	ITINREAD
...
extern void *llalloc(size_t size);

#define SIGNAL(sig,func) signal(sig,(signal_type)func)

/* # extern brk() */

#define EXTERN_BRK() extern int brk();

/* # extern sbrk() */

#define EXTERN_SBRK() extern void *sbrk();
...
#define LLBMEMALIGN(b) (char *)round((long)b+LLMAXPAGESIZE, LLMAXPAGESIZE)
