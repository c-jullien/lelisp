...
;;;
;;; $Source: /nfs/archives/lelisp15/work/GELL/C/RCS/modtoc.ll,v $
;;; $Date: 2002/03/28 16:50:25 $
;;; $Revision: 11.1 $
;;;
;;; ------------------------------------------------------------
   ...
   (if (probepathm module)
       (let ((defmod (readdefmodule module))
	    ...
	    (with ((outchan :include-channel))
		  ...
		  (with ((outchan :include-channel))
			(:princlude-list-of-decl "LLM3 functions" "extern Ptr" "()"
			     (mapcar 'cdr (reverse :llm3-functions)))
			(:princlude-list-of-decl "intern functions" "static Ptr" "()"
			     (mapcar 'cdr (reverse :module-functions)))
			(:princlude-list-of-decl "trace functions"  "static Ptr" "()"
...
; .SSection "Les instructions sur les fichiers"
	    ...
	    (MKDIR    ; LLM3 : strg cc
	              (:system-call-1-cc 'llrt_mkdir arg1 arg2))
	    (RMDIR    ; LLM3 : strg cc
	              (:system-call-1-cc 'llrt_rmdir arg1 arg2))
	    (CORSAV   ; LLM3 : strg cc
...
; .SSection "Les instructions syste`me"
	    ...
	    (DATE     ; LLM3 :op
	              (:system-call-1 'llrt_c_date arg1))
	    (GETENVRN ; LLM3 : strg1 strg2 cnt
	              (:system-call-2-cc 'llrt_c_getenv arg1 arg2 arg3))
...
; .SSection "Les instructions d'acce`s a` la me'moire"
	    ...
	    (HOVNI   ; LLM3 macro
	             (:wt1 "llrt_llovni(" (:opr arg1) "," (:opr arg2) ","
			   (:opr arg3) "," (:opr arg4) ");"))
