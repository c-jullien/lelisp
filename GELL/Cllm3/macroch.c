...
static Ptr GLmacroch_1() {      /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_mach); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_mach() {       /* ini_mach */
   {    register Ptr aRet;
...
static Ptr GLmacroch_2() {      /* ret_call_makevect_1 */
...
static Ptr GLmacroch_3() {      /* ret_call_makevect_2 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GItabccod = rA1;
...
extern Ptr GXdmc() {    /* dmc */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_4);
        {aRet = ((Ptr) GXllde); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_4() {      /* ret_call_llde_3 */
...
extern Ptr GXdms() {    /* dms */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_6);
        {aRet = ((Ptr) GXllde); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_6() {      /* ret_call_llde_4 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = rA1;
        (--rSp)->Val = ((Ptr) GLmacroch_5);
...
extern Ptr GXdefsharp() {       /* defsharp */
...
static Ptr GLmacroch_8() {      /* ret_call_trysympk_5 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = GMllexpr;
        GIa3 = (rSp++)->Val;
...
static Ptr GLmacroch_9() {      /* ret_call_setfn_6 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLmacroch_7() {      /* defshrer */
   {    register Ptr aRet;
        GIa1 = GIa2;
        GIa2 = GMdefsharp;
...
extern Ptr GXllquote() {        /* ' */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_10);
        {aRet = ((Ptr) GXreadi); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_10() {     /* ret_call_readi_7 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLmacroch_11() {     /* commain */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_12);
        {aRet = ((Ptr) GXgetch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_12() {     /* ret_call_getch_8 */
...
static Ptr GLmacroch_15() {     /* ret_call_rereada4_9 */
   {    register Ptr aRet;
        GIa1 = GMllcomma;
        {aRet = ((Ptr) GLmacroch_16); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_16() {     /* commain0 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
...
static Ptr GLmacroch_17() {     /* ret_call_readi_10 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
...
static Ptr GLmacroch_13() {     /* commain1 */
   {    register Ptr aRet;
        GIa1 = GMcommaat;
        {aRet = ((Ptr) GLmacroch_16); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_14() {     /* commain2 */
   {    register Ptr aRet;
        GIa1 = GMcommadot;
        {aRet = ((Ptr) GLmacroch_16); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXllbquote() {       /* ` */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = GMllcomma;
        (--rSp)->Val = (rA1 + 2)->Val;
...
static Ptr GLmacroch_19() {     /* ret_call_sysprot_11 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = GMllcomma;
...
static Ptr GLmacroch_18() {     /* llbquot1 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLmacroch_21() {     /* backcste */
...
static Ptr GLmacroch_20() {     /* backquot */
...
static Ptr GLmacroch_25() {     /* ret_call_backquot_13 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        {register Ptr aux;
                aux = rSp->Val;
...
static Ptr GLmacroch_26() {     /* ret_call_backquot_14 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
...
static Ptr GLmacroch_28() {     /* ret_call_backcste_15 */
...
l_backqu31:
        GIa1 = rA1; rA1 = llrt_cons (rA1, rNil);
        GIa1 = rA1; rA1 = llrt_cons (GMlist, rA1);
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa1 = rA1; return (aRet);}}

static Ptr GLmacroch_27() {     /* backqu32 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_29);
        {aRet = ((Ptr) GLmacroch_21); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_29() {     /* ret_call_backcste_16 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_31() {     /* ret_call_backcste_17 */
...
static Ptr GLmacroch_30() {     /* backqu34 */
...
l_backqu35:
        if (rA3 == GMlist)      goto l_backqu37;
        if (rA3 == GMmcons)     goto l_backqu37;
l_backqu36:
...
static Ptr GLmacroch_23() {     /* backquo4 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa2 = rA1->Val;
        (--rSp)->Val = (GIa2 + 1)->Val;
...
static Ptr GLmacroch_33() {     /* ret_call_backquot_18 */
...
static Ptr GLmacroch_24() {     /* backquo5 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLmacroch_34() {     /* ret_call_backquot_19 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLmacroch_32() {     /* backquo7 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLmacroch_22() {     /* backquor */
   {    register Ptr aRet;
        GIa1 = (Ptr) 12;
        GIa2 = GMllbquote;
        {aRet = ((Ptr) GXerrsxt); goto lRet;}
...
extern Ptr GXllsharp() {        /* # */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_35);
        {aRet = ((Ptr) GXgetch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_35() {     /* ret_call_getch_20 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_36);
        {aRet = ((Ptr) GXbase10p); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_36() {     /* ret_call_base10p_21 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLmacroch_38() {     /* rdsh3 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_40);
        {aRet = ((Ptr) GXgetch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_40() {     /* ret_call_getch_22 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_41);
        {aRet = ((Ptr) GXbase10p); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_41() {     /* ret_call_base10p_23 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_37() {     /* rdsh4 */
   {    register Ptr aRet;
        (--GIsp)->Val = (Ptr) 0;
        {aRet = ((Ptr) GLmacroch_42); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_42() {     /* rdsh5 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_43);
        {aRet = ((Ptr) GXasciii); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_43() {     /* ret_call_asciii_24 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa2 = rA1;
        (--rSp)->Val = rA1;
...
static Ptr GLmacroch_44() {     /* ret_call_getfns_25 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
extern Ptr GXshrpdot() {        /* . */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_45);
        {aRet = ((Ptr) GXreadi); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_45() {     /* ret_call_readi_26 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_46() {     /* shrpdot1 */
   {    register Ptr aRet;
         GIa1 = llrt_cons (GIa1, GInil);
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXshrpplu() {        /* + */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_47);
        {aRet = ((Ptr) GXreadi); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_47() {     /* ret_call_readi_28 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_48() {     /* ret_call_evala1_29 */
   {    register Ptr aRet;
        if (GIa1 == GInil)      {aRet = ((Ptr) GLmacroch_49); goto lRet;}
        {aRet = ((Ptr) GLmacroch_50); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_50() {     /* shrpplu0 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_46);
        {aRet = ((Ptr) GXreadi); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_49() {     /* shrpplu1 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_51);
        {aRet = ((Ptr) GXreadi); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_51() {     /* ret_call_readi_30 */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXshrpmoi() {        /* - */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_52);
        {aRet = ((Ptr) GXreadi); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_52() {     /* ret_call_readi_31 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_53() {     /* ret_call_evala1_32 */
   {    register Ptr aRet;
        if (GIa1 != GInil)      {aRet = ((Ptr) GLmacroch_49); goto lRet;}
        {aRet = ((Ptr) GLmacroch_50); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXshrpquo() {        /* #:gell:' */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_54);
        {aRet = ((Ptr) GXreadi); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_54() {     /* ret_call_readi_33 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIa1 = rA1; rA1 = llrt_cons (rA1, GInil);
...
extern Ptr GXshrpsla() {        /* / */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_55);
        {aRet = ((Ptr) GXgetch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_55() {     /* ret_call_getch_34 */
   {    register Ptr aRet;
        GIa1 = GIa4;
        {aRet = ((Ptr) GLmacroch_56); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXshrpbak() {        /* \ */
...
static Ptr GLmacroch_57() {     /* ret_call_readi_35 */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        rA2 = GMstatrc;
        rA2->Val = (rSp++)->Val;
...
static Ptr GLmacroch_58() {     /* ret_call_getprop_36 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
...
static Ptr GLmacroch_59() {     /* shrpbak1 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        GIa2 = GMshrpval;
...
extern Ptr GXshrphat() {        /* #:gell:^ */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_60);
        {aRet = ((Ptr) GXgetch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_60() {     /* ret_call_getch_37 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLmacroch_62() {     /* ret_call_sysprot_38 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIcpkgc = (rSp++)->Val;
...
static Ptr GLmacroch_61() {     /* shrpcol1 */
   {    register Ptr aRet;
        GIcpkgc = GInil;
...
static Ptr GLmacroch_63() {     /* ret_call_readi_39 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_65() {     /* ret_call_getcv_40 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLmacroch_64() {     /* shrpcol3 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIa1 = rA1; rA1 = llrt_cons (rA1, GInil);
        {aRet = (GIsp++)->Val; goto lRet;}
...
extern Ptr GXshrprad() {        /* r */
   {    register Ptr aRet;
        (--GIsp)->Val = GMshrprad;
        {aRet = ((Ptr) GLmacroch_66); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_66() {     /* shrprad1 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_67);
        {aRet = ((Ptr) GLmacroch_68); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_67() {     /* ret_call_shrprad2_43 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLmacroch_68() {     /* shrprad2 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIibase;
        GIibase = GIa1;
...
static Ptr GLmacroch_70() {     /* ret_call_sysprot_44 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = (rSp++)->Val;
        GIibase = (rSp++)->Val;
...
static Ptr GLmacroch_69() {     /* shrpradr */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
        {aRet = ((Ptr) GXerrsxt); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXshrpgui() {        /* " */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = ((Ptr) GLmacroch_71); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_72() {     /* shrpgui1 */
   {    register Ptr aRet;
         GIa1 = llrt_cons (GIa4, GIa1);
        {aRet = ((Ptr) GLmacroch_71); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_71() {     /* shrpgui2 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_73);
        {aRet = ((Ptr) GXgetch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_73() {     /* ret_call_getch_45 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_74() {     /* ret_call_getch_46 */
   {    register Ptr aRet;
        if (GIa4 == (Ptr) 34)   {aRet = ((Ptr) GLmacroch_72); goto lRet;}
...
static Ptr GLmacroch_75() {     /* ret_call_rereada4_47 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_76);
        {aRet = ((Ptr) GXnreverse); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_76() {     /* ret_call_nreverse_48 */
   {    register Ptr aRet;
         GIa1 = llrt_cons (GIa1, GInil);
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXshrpbar() {        /* | */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_77);
        {aRet = ((Ptr) GXgetcv); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_77() {     /* shrpbari */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLmacroch_79() {     /* ret_call_getcv_50 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_78() {     /* shrpbar0 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_80);
        {aRet = ((Ptr) GXgetcv); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_80() {     /* ret_call_getcv_51 */
   {    register Ptr aRet;
...
extern Ptr GXshrppar() {        /* ( */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_81);
        {aRet = ((Ptr) GXread2); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_81() {     /* ret_call_read2_52 */
...
extern Ptr GXshrpbra() {        /* #:gell:[ */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_82);
        {aRet = ((Ptr) GLmacroch_83); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_82() {     /* ret_call_shrpbra0_53 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_83() {     /* shrpbra0 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIcpkgc;
...
static Ptr GLmacroch_85() {     /* ret_call_sysprot_54 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIcpkgc = (rSp++)->Val;
...
static Ptr GLmacroch_84() {     /* shrpbra1 */
   {    register Ptr aRet;
        GIcpkgc = GInil;
        GIa1 = (Ptr) 93;
...
static Ptr GLmacroch_86() {     /* ret_call_readdltd_55 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
...
static Ptr GLmacroch_87() {     /* ret_call_lllength_56 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        GIa2 = GInil;
...
static Ptr GLmacroch_88() {     /* ret_call_makevect_57 */
...
static Ptr GLmacroch_56() {     /* lowbyte */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLmacroch_89() {     /* ret_call_getch_58 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLmacroch_91() {     /* ret_call_getch_59 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLmacroch_94() {     /* lowbytre */
   {    register Ptr aRet;
        GIa1 = (Ptr) ((UFix) (GIa1) | (UFix) (GIa4));
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_92() {     /* lowbyte3 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLmacroch_95);
        {aRet = ((Ptr) GXgetch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_95() {     /* ret_call_getch_61 */
   {    register Ptr aRet;
        GIa4 = (Ptr) ((UFix) (GIa4) & (UFix) 31);
        {aRet = ((Ptr) GLmacroch_94); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_93() {     /* lowbyte4 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
...
static Ptr GLmacroch_96() {     /* ret_call_readi_62 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        GIa2 = GMshrpval;
...
static Ptr GLmacroch_97() {     /* ret_call_getprop_63 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa2 = (rSp++)->Val;
        GIa4 = (rSp++)->Val;
...
static Ptr GLmacroch_90() {     /* lowbyte5 */
   {    register Ptr aRet;
        GIa2 = GIa1;
        GIa1 = GMshrpval;
...
static Ptr GLmacroch_98() {     /* ret_call_sysprot_64 */
   {    register Ptr aRet;
...
static Ptr GLmacroch_99() {     /* ret_call_getch_65 */
   {    register Ptr aRet;
        GIa4 = (Ptr) ((UFix) (GIa4) & (UFix) 31);
        {aRet = ((Ptr) GXasciii); goto lRet;}
  lRet:  return (aRet);}}
...
static Ptr GLmacroch_100() {    /* lllbra1 */
   {    register Ptr aRet;
        GIa2 = GMlread;
        {aRet = ((Ptr) GXerrudf); goto lRet;}
  lRet:  return (aRet);}}
...
extern Ptr GXtypech() { /* typech */
   {    register Ptr aRet;
        GIa2 = GMtypech;
        {aRet = ((Ptr) GLmacroch_101); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_101() {    /* typech0 */
...
static Ptr GLmacroch_104() {    /* ret_call_stringa1_66 */
   {    register Ptr aRet;
        GIa1 = (Ptr) ((unsigned char) *(((char *) (GIa1->Val + 2)) + (Fix) 0));
        {aRet = ((Ptr) GLmacroch_103); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_103() {    /* typechs8 */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        rA2 = (rSp++)->Val;
...
static Ptr GLmacroch_102() {    /* typechg1 */
   {    register Ptr aRet, rSp, rA1, rA2;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2;
        rA1 = (rSp++)->Val;
...
static Ptr GLmacroch_106() {    /* ret_call_stringa1_67 */
   {    register Ptr aRet;
        GIa1 = (Ptr) ((unsigned char) *(((char *) (GIa1->Val + 2)) + (Fix) 0));
        {aRet = ((Ptr) GLmacroch_105); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLmacroch_105() {    /* typechg7 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
