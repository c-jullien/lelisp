...
static Ptr GLbllsht_1() {       /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_bll); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_bll() {        /* ini_bll */
   {    register Ptr aRet;
...
extern Ptr GXvag() {    /* vag */
   {    register Ptr aRet;
        GIa2 = GMvag;
        {aRet = ((Ptr) GXvaga1); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXvaga1() {  /* vaga1 */
...
static Ptr GLbllsht_2() {       /* vagerr3 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GXerrnda); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLbllsht_3() {       /* vaga3 */
...
static Ptr GLbllsht_4() {       /* ret_call_adrverif_1 */
   {    register Ptr aRet;
...
static Ptr GLbllsht_7() {       /* ret_call_adrverif_2 */
...
static Ptr GLbllsht_8() {       /* ret_call_adrverif_3 */
   {    register Ptr aRet;
        {register int aux0, aux1, aux2;
                aux0 = (int) ((UFix) GIa3); aux1 = aux0 << HIGHTSHIFT;
                aux0 = (int) ((UFix) GIa1); aux1 = aux0 + aux1;
...
static Ptr GLbllsht_9() {       /* ret_call_adrverif_4 */
...
static Ptr GLbllsht_5() {       /* adrverif */
...
static Ptr GLbllsht_6() {       /* adrcreat */
...
static Ptr GLbllsht_11() {      /* ret_call_vaga1_5 */
   {    register Ptr aRet;
        GIccode = GIa1;
        {aRet = ((Ptr) GLbllsht_10); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLbllsht_10() {      /* accodeg */
   {    register Ptr aRet;
        GIa1 = GIccode;
        {aRet = ((Ptr) GXloc); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXaecode() { /* ecode */
   {    register Ptr aRet;
        GIa1 = GIecode;
        {aRet = ((Ptr) GXloc); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXmemory() { /* memory */
   {    register Ptr aRet;
        GIa2 = GMmemory;
        GIa3 = ((Ptr) GLbllsht_12);
        (--GIsp)->Val = ((Ptr) GLbllsht_13);
        {aRet = ((Ptr) GLbllsht_14); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLbllsht_13() {      /* ret_call_getsetad_6 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        {register Fix *adr;
                adr = (Fix *) rA1;
...
static Ptr GLbllsht_12() {      /* memory2 */
   {    register Ptr aRet;
        {register Fix *adr;
                adr = (Fix *) GIa3;
                *adr = (Fix) (GIa1);}
...
extern Ptr GXbltmemory() {      /* bltmemory */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa2;
        GIa2 = GMbltmemory;
...
static Ptr GLbllsht_15() {      /* ret_call_vaga1_7 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLbllsht_16);
        {aRet = ((Ptr) GLbllsht_3); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLbllsht_16() {      /* ret_call_vaga3_8 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = GIa1;
        GIa1 = rSp->Val;
        (--rSp)->Val = ((Ptr) GLbllsht_17);
        {aRet = ((Ptr) GXvaga1); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLbllsht_17() {      /* ret_call_vaga1_9 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = GIa4;
...
extern Ptr GXprecomp() {        /* precompile */
   {    register Ptr aRet;
        GIa1 = GIa1->Val;
...
extern Ptr GXllcall() { /* call */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        if (GIa4 != (Ptr) 4)    {aRet = ((Ptr) GLbllsht_18); goto lRet;}
        GIa3 = (rSp++)->Val;
        GIa2 = (rSp++)->Val;
        GIa4 = (rSp++)->Val;
        GIa1 = (rSp++)->Val;
        (--rSp)->Val = GIa2;
        (--rSp)->Val = ((Ptr) GLbllsht_19);
        {aRet = ((Ptr) GXvaga1); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLbllsht_19() {      /* ret_call_vaga1_10 */
...
static Ptr GLbllsht_18() {      /* callerr1 */
   {    register Ptr aRet;
        GIa2 = GMllcall;
        GIa1 = (Ptr) 4;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
...
extern Ptr GXllcaln() { /* calln */
   {    register Ptr aRet;
        GIa3 = GIa2;
        GIa2 = GMllcaln;
        (--GIsp)->Val = ((Ptr) GLbllsht_20);
        {aRet = ((Ptr) GXvaga1); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLbllsht_20() {      /* ret_call_vaga1_11 */
...
static Ptr GLbllsht_14() {      /* getsetad */
   {    register Ptr aRet, rSp, rA1, rA3, rA4;
        rSp = GIsp; rA1 = GIa1; rA3 = GIa3; rA4 = GIa4;
        if (rA4 == (Ptr) 1)     goto l_getseta1;
        if (rA4 == (Ptr) 2)     goto l_getseta2;
        rA1 = (Ptr) 2;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
l_getseta1:
        rA3 = (rSp++)->Val;
...
extern Ptr GXepur() {   /* epur */
   {    register Ptr aRet;
  lRet:  return (aRet);}}

static Ptr GDbllsht_21() {      /* trace loc */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,0,1,2);
  lRet:  return (aRet);}}

static Ptr GDbllsht_22() {      /* trace locint */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,3,1,2);
  lRet:  return (aRet);}}

static Ptr GDbllsht_23() {      /* trace vag */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,4,1,2);
  lRet:  return (aRet);}}

static Ptr GDbllsht_24() {      /* trace addadr */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,5,1,6);
  lRet:  return (aRet);}}

static Ptr GDbllsht_25() {      /* trace incradr */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,7,1,6);
  lRet:  return (aRet);}}

static Ptr GDbllsht_26() {      /* trace subadr */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,8,1,6);
  lRet:  return (aRet);}}

static Ptr GDbllsht_27() {      /* trace gtadr */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,9,1,6);
  lRet:  return (aRet);}}

static Ptr GDbllsht_28() {      /* trace ccode */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,10,1,11);
  lRet:  return (aRet);}}

static Ptr GDbllsht_29() {      /* trace ecode */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,12,1,13);
  lRet:  return (aRet);}}

static Ptr GDbllsht_30() {      /* trace memory */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,14,1,11);
  lRet:  return (aRet);}}

static Ptr GDbllsht_31() {      /* trace bltmemory */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,15,1,16);
  lRet:  return (aRet);}}

static Ptr GDbllsht_32() {      /* trace precompile */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,17,1,18);
  lRet:  return (aRet);}}

static Ptr GDbllsht_33() {      /* trace call */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYbllsht,19,1,11);
  lRet:  return (aRet);}}

static Ptr GDbllsht_34() {      /* trace calln */
   {    register Ptr aRet;
