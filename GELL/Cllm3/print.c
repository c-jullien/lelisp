...
static Ptr GLprint_1() {        /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_print); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_print() {      /* ini_print */
   {    register Ptr aRet;
        GIiexpld = GInil;
        GIobase = (Ptr) 10;
        GIprmdp = (Ptr) 100;
...
static Ptr GLprint_2() {        /* ret_call_makestrg_1 */
   {    register Ptr aRet;
        GIbufpn = GIa1;
...
static Ptr GLprint_3() {        /* prtrue */
   {    register Ptr aRet;
        GIa1 = GMt;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXu_print() {        /* u_print */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_4);
        {aRet = ((Ptr) GXprobj); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_4() {        /* ret_call_probj_2 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLprint_5); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXflulin() { /* flulin */
...
static Ptr GLprint_6() {        /* ret_call_itsoft_4 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = (rSp++)->Val;
        GIa3 = (rSp++)->Val;
...
static Ptr GLprint_7() {        /* ret_call_itsoft_5 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = (rSp++)->Val;
        GIa3 = (rSp++)->Val;
...
extern Ptr GXeol() {    /* eol */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_8);
        {aRet = ((Ptr) GLprint_9); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_8() {        /* ret_call_outlin_6 */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXllfflush() {       /* flush */
...
static Ptr GLprint_11() {       /* ret_call_tystrg_7 */
   {    register Ptr aRet;
        GIpocour = (GIsp++)->Val;
        {aRet = ((Ptr) GLprint_12); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_10() {       /* fflush1 */
...
static Ptr GLprint_12() {       /* fflush3 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_13);
        {aRet = ((Ptr) GLprint_14); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_13() {       /* ret_call_outli2_8 */
   {    register Ptr aRet;
        GIpocour = (Ptr) 0;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_9() {        /* outlin */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLprint_17() {       /* ret_call_tystrg_9 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_18);
        {aRet = ((Ptr) GXtynewln); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_18() {       /* ret_call_tynewln_10 */
   {    register Ptr aRet;
        GIpocour = (GIsp++)->Val;
        {aRet = ((Ptr) GLprint_14); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_16() {       /* outli1 */
   {    register Ptr aRet;
        GIa3 = (GIcuroutch->Val + 2 + (Fix) 1)->Val;
...
static Ptr GLprint_23() {       /* ret_call_chklp_11 */
   {    register Ptr aRet;
        GIa1 = GIpocour;
        {aRet = ((Ptr) GLprint_22); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_22() {       /* outch1 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLprint_28() {       /* ret_call_chklp_12 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLprint_27() {       /* outsp2 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_29);
        {aRet = ((Ptr) GLprint_19); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_29() {       /* ret_call_chklp_13 */
   {    register Ptr aRet;
        GIa1 = GIpocour;
        {aRet = ((Ptr) GLprint_26); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_30() {       /* outshrp */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLprint_33() {       /* ret_call_chklp_14 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        rA1 = GIpocour;
        rA1 = (Ptr) ((UFix) ((Fix) (rA1) + (Fix) (1)));
...
static Ptr GLprint_32() {       /* outshrp1 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLprint_36() {       /* ret_call_outch_15 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_37);
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_37() {       /* ret_call_outch_16 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_20);
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_38() {       /* pratom */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        rA2 = GIprcln;
...
static Ptr GLprint_39() {       /* ret_call_gettype_18 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLprint_41() {       /* ret_call_getfns_19 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLprint_40() {       /* pratom2 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GXupratom); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXupratom() {        /* pratom */
...
static Ptr GLprint_48() {       /* prsympk1 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = rA1;
        rA1 = (rA1 + 3)->Val;
...
static Ptr GLprint_49() {       /* ret_call_prpkg_20 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GLprint_47); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_50() {       /* prpkg */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIprcpk;
        GIa3 = ((Ptr) GLprint_51);
...
static Ptr GLprint_52() {       /* ret_call_sysprot_21 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIprcpk = (rSp++)->Val;
...
static Ptr GLprint_54() {       /* ret_call_outshrp_22 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_55);
        {aRet = ((Ptr) GLprint_56); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_55() {       /* ret_call_probj0_23 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 58;
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_53() {       /* prpkgsym */
   {    register Ptr aRet;
...
static Ptr GLprint_58() {       /* ret_call_chksymb_24 */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        if (rA2 == GInil)       {aRet = ((Ptr) GLprint_57); goto lRet;}
...
static Ptr GLprint_61() {       /* ret_call_outch_26 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_62);
        {aRet = ((Ptr) GXstrgsymb); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_62() {       /* ret_call_strgsymb_27 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIsavea1 = rA1;
        GIa2 = (rA1->Val + 1)->Val;
...
static Ptr GLprint_65() {       /* prat11 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_66);
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_66() {       /* ret_call_outch_29 */
   {    register Ptr aRet;
        GIa3 = (Ptr) ((UFix) ((Fix) (GIa3) + (Fix) (1)));
        {aRet = ((Ptr) GLprint_63); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_63() {       /* prat12 */
   {    register Ptr aRet;
...
static Ptr GLprint_67() {       /* ret_call_outch_30 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 58;
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_57() {       /* prat2 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_68);
        {aRet = ((Ptr) GXstrgsymb); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_68() {       /* ret_call_strgsymb_31 */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        GIa3 = (GIa1->Val + 1)->Val;
        rA2 = GIa3;
...
static Ptr GLprint_73() {       /* ret_call_outch_33 */
   {    register Ptr aRet;
        GIa2 = (Ptr) ((UFix) ((Fix) (GIa2) + (Fix) (1)));
        {aRet = ((Ptr) GLprint_70); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_70() {       /* prat8 */
   {    register Ptr aRet;
        {register Fix aux;
                aux = (Fix) (GIa3) - 1;
                GIa3 = (Ptr) ((UFix) aux);
...
static Ptr GLprint_74() {       /* ret_call_outch_34 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 41;
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_59() {       /* chksymb */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
...
static Ptr GLprint_75() {       /* ret_call_strgsymb_35 */
...
static Ptr GLprint_77() {       /* prtypvec */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLprint_78() {       /* ret_call_prpkg_36 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLprint_44() {       /* prstrg */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_79);
        {aRet = ((Ptr) GLprint_77); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_79() {       /* ret_call_prtypvec_37 */
...
static Ptr GLprint_71() {       /* prathb */
   {    register Ptr aRet;
        GIa2 = (Ptr) 0;
        {aRet = ((Ptr) GLprint_81); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_82() {       /* prathb2 */
   {    register Ptr aRet;
...
static Ptr GLprint_83() {       /* ret_call_outch_39 */
   {    register Ptr aRet;
        GIa2 = (Ptr) ((UFix) ((Fix) (GIa2) + (Fix) (1)));
        {aRet = ((Ptr) GLprint_81); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_81() {       /* prathb4 */
   {    register Ptr aRet;
        {register Fix aux;
                aux = (Fix) (GIa3) - 1;
                GIa3 = (Ptr) ((UFix) aux);
...
static Ptr GLprint_80() {       /* prstr5 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_84);
        {aRet = ((Ptr) GLprint_76); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_84() {       /* ret_call_chkstrg_40 */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        rA2 = (Ptr) ((UFix) ((Fix) (rA2) + (Fix) 2));
        rA2 = (Ptr) ((UFix) ((Fix) (rA2) + (Fix) (GIpocour)));
...
static Ptr GLprint_86() {       /* ret_call_outch_42 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIsavea1 = rA1;
        rA1 = (rA1->Val + 1)->Val;
...
static Ptr GLprint_89() {       /* prstr61 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_90);
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_90() {       /* ret_call_outch_44 */
   {    register Ptr aRet;
        GIa3 = (Ptr) ((UFix) ((Fix) (GIa3) + (Fix) (1)));
        {aRet = ((Ptr) GLprint_87); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_88() {       /* prstr63 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 34;
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_45() {       /* prvect */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        rA2 = GIprcdp;
...
static Ptr GLprint_92() {       /* ret_call_outshrp_46 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_93);
        {aRet = ((Ptr) GLprint_94); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_93() {       /* ret_call_prvectin_47 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 93;
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_94() {       /* prvectin */
   {    register Ptr aRet;
        GIa2 = (GIa1->Val + 1)->Val;
        GIa3 = (Ptr) 0;
...
static Ptr GLprint_97() {       /* ret_call_probj0_48 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = rSp->Val;
...
static Ptr GLprint_100() {      /* ret_call_getnumi_50 */
   {    register Ptr aRet;
        GIa4 = (GIsp++)->Val;
        {aRet = ((Ptr) GLprint_99); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_99() {       /* prnum0 */
   {    register Ptr aRet, rA3;
        rA3 = GIa3;
        rA3 = GIa2;
...
static Ptr GLprint_101() {      /* prnum1 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 0;
        {aRet = ((Ptr) GLprint_102); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_103() {      /* prnum3 */
   {    register Ptr aRet;
...
static Ptr GLprint_104() {      /* ret_call_outch_52 */
   {    register Ptr aRet;
        GIa1 = (Ptr) ((UFix) ((Fix) (GIa1) + (Fix) (1)));
        {aRet = ((Ptr) GLprint_102); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_102() {      /* prnum4 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        {register Fix aux;
                aux = (Fix) (GIa2) - 1;
...
static Ptr GLprint_20() {       /* probjend */
   {    register Ptr aRet;
        GIa2 = GMprin;
        {aRet = ((Ptr) GXfindtag); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_106() {      /* probj01 */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        GIprclp = GIprmlp;
        rA2 = GIprmln;
...
static Ptr GLprint_108() {      /* ret_call_gettype_53 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLprint_110() {      /* ret_call_getfns_54 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLprint_109() {      /* probj12 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
l_probj2:
...
static Ptr GLprint_113() {      /* ret_call_outch_56 */
   {    register Ptr aRet;
        GIa1 = GIa2->Val;
...
static Ptr GLprint_114() {      /* probjd */
   {    register Ptr aRet;
        GIa4 = (Ptr) 46;
        {aRet = ((Ptr) GXoutch); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_115() {      /* probj6 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_111);
        {aRet = ((Ptr) GLprint_24); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_111() {      /* probj8 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLprint_116() {      /* ret_call_probj0_59 */
...
static Ptr GLprint_118() {      /* ret_call_outsp_60 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_119);
        {aRet = ((Ptr) GLprint_114); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_119() {      /* ret_call_probjd_61 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_120);
        {aRet = ((Ptr) GLprint_24); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_120() {      /* ret_call_outsp_62 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_117);
        {aRet = ((Ptr) GLprint_56); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_117() {      /* probj9 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 41;
...
extern Ptr GXprobjt() { /* probjt */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_19);
        {aRet = ((Ptr) GXprobj); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXprin() {   /* prin */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLprint_121); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_121() {      /* prinn */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLprint_125() {      /* prinn2 */
   {    register Ptr aRet;
        GIa4 = (GIsp++)->Val;
        {aRet = ((Ptr) GLprint_123); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_123() {      /* prinn1 */
...
static Ptr GLprint_126() {      /* ret_call_probj_65 */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
        rA4 = (rSp++)->Val;
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
...
static Ptr GLprint_122() {      /* prinnr */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXprint() {  /* print */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_5);
        {aRet = ((Ptr) GLprint_121); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXprinflush() {      /* prinflush */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXflulin);
        {aRet = ((Ptr) GLprint_121); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXterpri() { /* terpri */
   {    register Ptr aRet, rA1, rA4;
        rA1 = GIa1; rA4 = GIa4;
        GIa2 = GMterpri;
...
static Ptr GLprint_128() {      /* terpr5 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLprint_127);
        {aRet = ((Ptr) GLprint_5); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_127() {      /* terpr6 */
   {    register Ptr aRet;
        {register Fix aux;
                aux = (Fix) (GIa1) - 1;
                GIa1 = (Ptr) ((UFix) aux);
...
static Ptr GLprint_129() {      /* ret_call_stringa1_69 */
   {    register Ptr aRet;
...
static Ptr GLprint_130() {      /* ret_call_princr1_70 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLprint_131() {      /* princr1 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIprclp = GIprmlp;
        (--rSp)->Val = GMprin;
...
static Ptr GLprint_133() {      /* princr2 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa2;
...
static Ptr GLprint_134() {      /* ret_call_outch_71 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
        {aRet = ((Ptr) GLprint_132); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_132() {      /* princr3 */
   {    register Ptr aRet;
        {register Fix aux;
                aux = (Fix) (GIa2) - 1;
                GIa2 = (Ptr) ((UFix) aux);
...
static Ptr GLprint_135() {      /* ret_call_princr1_72 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLprint_137() {      /* ret_call_sysprot_73 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIiexpld = (rSp++)->Val;
...
static Ptr GLprint_136() {      /* explode1 */
...
static Ptr GLprint_138() {      /* ret_call_probj_74 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = (rSp++)->Val;
        rA1 = (rA1 + 1)->Val;
...
static Ptr GLprint_15() {       /* expls */
   {    register Ptr aRet;
        (--GIsp)->Val = GIa4;
        GIa4 = (Ptr) 32;
        {aRet = ((Ptr) GLprint_139); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_31() {       /* explsh */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa4;
        GIa4 = (Ptr) 35;
        (--rSp)->Val = ((Ptr) GLprint_140);
        {aRet = ((Ptr) GLprint_21); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLprint_140() {      /* ret_call_explch_75 */
   {    register Ptr aRet;
        GIa4 = GIsp->Val;
        {aRet = ((Ptr) GLprint_139); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_21() {       /* explch */
   {    register Ptr aRet;
        (--GIsp)->Val = GIa4;
        {aRet = ((Ptr) GLprint_139); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_139() {      /* explch1 */
...
extern Ptr GXfobase() { /* obase */
   {    register Ptr aRet, rSp;
        ...
        (--rSp)->Val = (Ptr) 2;
        (--rSp)->Val = (Ptr) 36;
        (--rSp)->Val = ((Ptr) GLprint_141);
        {aRet = ((Ptr) GXgetsetn); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLprint_141() {      /* ret_call_getsetn_76 */
   {    register Ptr aRet;
        GIobase = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXprline() { /* printline */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = GMprline;
        GIa3 = GIprmlp;
...
static Ptr GLprint_142() {      /* ret_call_getsetn_77 */
   {    register Ptr aRet;
        GIprmlp = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXprlevel() {        /* printlevel */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = GMprlevel;
        GIa3 = GIprmdp;
        (--rSp)->Val = (Ptr) 0;
        (--rSp)->Val = (Ptr) 32767;
        (--rSp)->Val = ((Ptr) GLprint_143);
        {aRet = ((Ptr) GXgetsetn); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLprint_143() {      /* ret_call_getsetn_78 */
   {    register Ptr aRet;
        GIprmdp = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXprlength() {       /* printlength */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = GMprlength;
        GIa3 = GIprmln;
...
static Ptr GLprint_144() {      /* ret_call_getsetn_79 */
   {    register Ptr aRet;
        GIprmln = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLprint_145() {      /* tespos */
   {    register Ptr aRet, rA1, rA4;
        rA1 = GIa1; rA4 = GIa4;
...
static Ptr GLprint_146() {      /* ret_call_getsetn_80 */
   {    register Ptr aRet;
        GInbleft = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXrmargin() {        /* rmargin */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        (--rSp)->Val = (Ptr) 1;
...
static Ptr GLprint_147() {      /* ret_call_getsetn_81 */
   {    register Ptr aRet, rA1, rA2;
        rA1 = GIa1; rA2 = GIa2;
        GInbrig = rA1;
        rA2 = (GIbufout->Val + 1)->Val;
...
static Ptr GLprint_148() {      /* ret_call_getsetn_82 */
   {    register Ptr aRet;
        GIpocour = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXoutbuf() { /* outbuf */
   {    register Ptr aRet, rSp, rA1, rA2, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA4 = GIa4;
...
l_outbu5:
        rA1 = (rSp++)->Val;
        rA4 = GMoutbuf;
        (--rSp)->Val = ((Ptr) GLprint_149);
        {aRet = ((Ptr) GLprint_145); goto lRet;}
  lRet: GIsp = rSp; GIa1 = rA1; GIa2 = rA2; GIa4 = rA4; return (aRet);}}

static Ptr GLprint_149() {      /* ret_call_tespos_83 */
   {    register Ptr aRet, rA1, rA2;
        rA1 = GIa1; rA2 = GIa2;
...
static Ptr GDprint_150() {      /* trace eol */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,0,1,2);
  lRet:  return (aRet);}}

static Ptr GDprint_151() {      /* trace flush */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,3,1,2);
  lRet:  return (aRet);}}

static Ptr GDprint_152() {      /* trace pratom */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,4,1,5);
  lRet:  return (aRet);}}

static Ptr GDprint_153() {      /* trace prin */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,6,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_154() {      /* trace print */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,8,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_155() {      /* trace prinflush */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,9,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_156() {      /* trace terpri */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,10,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_157() {      /* trace princh */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,11,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_158() {      /* trace princn */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,12,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_159() {      /* trace explode */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,13,1,5);
  lRet:  return (aRet);}}

static Ptr GDprint_160() {      /* trace ptype */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,14,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_161() {      /* trace obase */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,15,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_162() {      /* trace printline */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,16,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_163() {      /* trace printlevel */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,17,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_164() {      /* trace printlength */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,18,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_165() {      /* trace lmargin */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,19,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_166() {      /* trace rmargin */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,20,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_167() {      /* trace outpos */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYprint,21,1,7);
  lRet:  return (aRet);}}

static Ptr GDprint_168() {      /* trace outbuf */
   {    register Ptr aRet;
