...
static Ptr GLnumber_1() {       /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_nbs); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_nbs() {        /* ini_nbs */
   {    register Ptr aRet;
...
static Ptr GLnumber_3() {       /* ret_call_gettype_1 */
...
static Ptr GLnumber_5() {       /* ret_call_getfns_2 */
...
static Ptr GLnumber_7() {       /* ret_call_ffsymbol_3 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp + (Fix) 1)->Val;
        GIa3 = GInil;
...
static Ptr GLnumber_9() {       /* ret_call_bangen_5 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = (rSp++)->Val;
        GIa1 = (rSp++)->Val;
...
static Ptr GLnumber_10() {      /* bangen2 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        (--rSp)->Val = GIa2;
...
static Ptr GLnumber_11() {      /* ret_call_bangen_6 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa4 = (rSp++)->Val;
        rA1 = (rSp++)->Val;
...
static Ptr GLnumber_13() {      /* ret_call_gettype_7 */
...
static Ptr GLnumber_15() {      /* ret_call_getfns_8 */
   {    register Ptr aRet;
...
static Ptr GLnumber_14() {      /* nbpn */
   {    register Ptr aRet;
        GIsp += (Fix) 1;
        {aRet = ((Ptr) GLnumber_16); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_16() {      /* nbpnil */
   {    register Ptr aRet;
        GIa1 = GInil;
l_nbpt:
        {aRet = (GIsp++)->Val; goto lRet;}
...
extern Ptr GXrationalp() {      /* rationalp */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        if (rA1 < GIbfloat)     { aRet = (GIsp++)->Val; goto lRet;}
        if (llrt_floatp (rA1) != 0) 
...
extern Ptr GXlltrunc() {        /* truncate */
   {    register Ptr aRet;
        {aRet = ((Ptr) GLnumber_17); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_17() {      /* lltrunc1 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa3 = GMlltrunc;
        if (rA1 < GIbfloat)     { aRet = (rSp++)->Val; goto lRet;}
...
extern Ptr GXllfix() {  /* fix */
   {    register Ptr aRet;
        {aRet = ((Ptr) GLnumber_17); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgaadd1() { /* 1+ */
...
extern Ptr GXgaplus2i() {       /* gaplus2i */
...
static Ptr GLnumber_18() {      /* gapplus */
...
static Ptr GLnumber_19() {      /* gaplus1 */
...
static Ptr GLnumber_20() {      /* ret_call_bangen2_9 */
   {    register Ptr aRet;
        GIa4 = (GIsp++)->Val;
        {aRet = ((Ptr) GLnumber_19); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgatimes() {        /* * */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLnumber_21() {      /* gattimes */
   {    register Ptr aRet, rSp, rA1, rA4;
        rSp = GIsp; rA1 = GIa1; rA4 = GIa4;
...
static Ptr GLnumber_22() {      /* gatime1 */
   {    register Ptr aRet, rSp, rA1, rA2, rA4, rBfloat;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA4 = GIa4; rBfloat = GIbfloat;
...
static Ptr GLnumber_23() {      /* ret_call_bangen2_10 */
   {    register Ptr aRet;
        GIa4 = (GIsp++)->Val;
        {aRet = ((Ptr) GLnumber_22); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgadinv() { /* 0- */
   {    register Ptr aRet;
        GIa2 = GIa1;
...
static Ptr GLnumber_25() {      /* gadiff2 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GLnumber_27); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_27() {      /* gadiffp */
   {    register Ptr aRet;
        GIa2 = GIa1;
        GIa1 = (GIsp++)->Val;
...
extern Ptr GXgadiff2i() {       /* gadiff2i */
...
static Ptr GLnumber_26() {      /* gadiff3 */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
...
static Ptr GLnumber_32() {      /* garevret */
   {    register Ptr aRet;
        GIa1 = (Ptr) 1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_30() {      /* gadiv1 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
        {aRet = ((Ptr) GLnumber_28); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_28() {      /* garev */
...
static Ptr GLnumber_29() {      /* gadiv2 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GLnumber_33); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_33() {      /* gadivt */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rBfloat;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rBfloat = GIbfloat;
        rA2 = rA1;
        rA1 = (rSp++)->Val;
...
extern Ptr GXgamod() {  /* modulo */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLnumber_34);
        {aRet = ((Ptr) GXgaquomod); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_34() {      /* ret_call_gaquomod_11 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        rA1 = GMexmod;
        rA1 = rA1->Val;
...
static Ptr GLnumber_42() {      /* gacomfx0 */
   {    register Ptr aRet, rA1, rA2;
        rA1 = GIa1; rA2 = GIa2;
...
static Ptr GLnumber_37() {      /* gacomfx1 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
        {register Fix aux;
                aux = (Fix) (rA4) - 1;
...
static Ptr GLnumber_43() {      /* gacomfl0 */
   {    register Ptr aRet;
         GIa1 = llrt_float (GIa1);
        {aRet = ((Ptr) GLnumber_45); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_46() {      /* gacomfl1 */
...
static Ptr GLnumber_45() {      /* gacomfl2 */
   {    register Ptr aRet, rA1, rA2;
        rA1 = GIa1; rA2 = GIa2;
...
static Ptr GLnumber_38() {      /* gacomfl3 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
        {register Fix aux;
                aux = (Fix) (rA4) - 1;
...
static Ptr GLnumber_39() {      /* gacomgn0 */
   {    register Ptr aRet;
        GIa2 = (GIsp + (Fix) (GIa4))->Val;
        {aRet = ((Ptr) GLnumber_44); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLnumber_44() {      /* gacomgn1 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa4;
        (--rSp)->Val = GIa3;
...
static Ptr GLnumber_47() {      /* ret_call_bangensp2_12 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa2 = (rSp++)->Val;
        GIa3 = (rSp++)->Val;
...
static Ptr GLnumber_48() {      /* bangensp2 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = ((Ptr) GXpopj0);
        (--rSp)->Val = GIa1;
...
static Ptr GLnumber_49() {      /* ret_call_bangen_13 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp + (Fix) 2)->Val;
        GIa3 = GIcpfnt;
...
static Ptr GLnumber_51() {      /* ret_call_bangen_14 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa4 = (rSp++)->Val;
        rA1 = (rSp++)->Val;
...
static Ptr GLnumber_52() {      /* gaeqnret */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa3 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLnumber_56() {      /* ret_call_mintwo_15 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = (rSp++)->Val;
...
static Ptr GLnumber_61() {      /* ret_call_maxtwo_16 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = (rSp++)->Val;
