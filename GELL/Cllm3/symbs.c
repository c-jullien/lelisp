...
static Ptr GLsymbs_1() {        /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_sym); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_sym() {        /* ini_sym */
   {    register Ptr aRet;
...
static Ptr GLsymbs_2() {        /* sybfalse */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXmakunbound() {     /* makunbound */
...
static Ptr GLsymbs_4() {        /* ret_call_getset12_1 */
   {    register Ptr aRet;
        GIa1 = (GIa1 + 1)->Val;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_3() {        /* setplist */
   {    register Ptr aRet;
        (GIa3 + 1)->Val = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXpckgcell() {       /* packagecell */
   {    register Ptr aRet;
        GIa2 = GMpckgcell;
        GIa3 = ((Ptr) GLsymbs_6);
...
static Ptr GLsymbs_7() {        /* ret_call_getset12_2 */
   {    register Ptr aRet;
        GIa1 = (GIa1 + 3)->Val;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_6() {        /* pckgset */
   {    register Ptr aRet;
        (GIa3 + 3)->Val = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXd3root() { /* 3d-root-symbol */
...
static Ptr GLsymbs_9() {        /* ret_call_getset12_3 */
   {    register Ptr aRet;
        GIa1 = (GIa1 + 4)->Val;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_8() {        /* objvset */
   {    register Ptr aRet;
        (GIa3 + 4)->Val = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXvalfn() {  /* valfn */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLsymbs_13() {       /* ret_call_getsym1i_5 */
   {    register Ptr aRet;
        {register UFix aux;
                aux = (UFix) ((GIa1 + 6)->Val);
                GIa2 = (Ptr) aux;}
...
static Ptr GLsymbs_12() {       /* getfn1r1 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLsymbs_11); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_11() {       /* getfn1r2 */
   {    register Ptr aRet;
        GIa2 = GMgetfn1;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgetfn() {  /* getfn */
...
static Ptr GLsymbs_16() {       /* getfner1 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLsymbs_17); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_17() {       /* getfner2 */
   {    register Ptr aRet;
        GIa2 = GMgetfn;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_15() {       /* getfner3 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgetfns() { /* getfns */
   {    register Ptr aRet, rA1, rA2, rBsymb, rBcons;
        rA1 = GIa1; rA2 = GIa2; rBsymb = GIbsymb; rBcons = GIbcons;
...
static Ptr GLsymbs_20() {       /* ret_call_getfn5_6 */
...
static Ptr GLsymbs_24() {       /* ret_call_getfn8_7 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa4 = (rSp++)->Val;
...
static Ptr GLsymbs_21() {       /* getfnone */
...
static Ptr GLsymbs_28() {       /* ret_call_getfno3_8 */
...
static Ptr GLsymbs_32() {       /* getbi1 */
   {    register Ptr aRet;
        (--GIsp)->Val = GIa2;
        {aRet = ((Ptr) GLsymbs_33); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_33() {       /* getbi2 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
...
static Ptr GLsymbs_34() {       /* ret_call_getbi1i_9 */
...
static Ptr GLsymbs_31() {       /* getbier3 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GLsymbs_29); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_30() {       /* getbier2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLsymbs_29); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_29() {       /* getbier1 */
   {    register Ptr aRet;
        GIa2 = GMgetbi;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_35() {       /* getbi1i */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4, rBcons;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4; rBcons = GIbcons;
        rA4 = (rA3 + 3)->Val;
...
static Ptr GLsymbs_37() {       /* ret_call_errudf_10 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GXsynonym); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXsynqnym() {        /* synonymq */
   {    register Ptr aRet, rA1, rA2, rBsymb, rBcons;
        rA1 = GIa1; rA2 = GIa2; rBsymb = GIbsymb; rBcons = GIbcons;
        rA2 = (rA1 + 1)->Val;
        rA1 = rA1->Val;
...
static Ptr GLsymbs_39() {       /* getsymi1 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLsymbs_40() {       /* ret_call_getsym1i_11 */
   {    register Ptr aRet, rSp, rA1, rNil;
        rSp = GIsp; rA1 = GIa1; rNil = GInil;
...
static Ptr GLsymbs_38() {       /* getsymer */
   {    register Ptr aRet;
        GIa1 = GMgetsymb;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgetsym1() {        /* getsymb1 */
   {    register Ptr aRet, rA1, rA2, rBsymb, rBcons;
        rA1 = GIa1; rA2 = GIa2; rBsymb = GIbsymb; rBcons = GIbcons;
...
static Ptr GLsymbs_14() {       /* getsym1i */
...
static Ptr GLsymbs_42() {       /* getsy1r2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLsymbs_41); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_41() {       /* getsy1r1 */
   {    register Ptr aRet;
        GIa2 = GMgetsym1;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_43() {       /* geti */
...
static Ptr GLsymbs_45() {       /* ret_call_geti_12 */
...
static Ptr GLsymbs_44() {       /* putperr */
   {    register Ptr aRet;
        GIa2 = GMputprop;
        {aRet = ((Ptr) GXerrnva); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXdefprop() {        /* defprop */
...
static Ptr GLsymbs_47() {       /* ret_call_geti_13 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4, rBcons;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4; rBcons = GIbcons;
        if ((long) rA4 < (long) rBcons) {aRet = ((Ptr) GLsymbs_2); goto lRet;}
        (--rSp)->Val = rA4;
...
static Ptr GLsymbs_46() {       /* remperr */
   {    register Ptr aRet;
        GIa2 = GMremprop;
        {aRet = ((Ptr) GXerrnva); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLsymbs_5() {        /* getset12 */
...
static Ptr GLsymbs_50() {       /* ret_call_gaplus2i_15 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
        GIa2->Val = GIa1;
...
static Ptr GLsymbs_49() {       /* increrr1 */
   {    register Ptr aRet;
        GIa2 = GMfincr;
        {aRet = ((Ptr) GXerrnva); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXfdecr() {  /* decr */
   {    register Ptr aRet, rSp, rA1, rNil;
        rSp = GIsp; rA1 = GIa1; rNil = GInil;
        (--rSp)->Val = rA1->Val;
        rA1 = (rA1 + 1)->Val;
...
static Ptr GLsymbs_53() {       /* ret_call_gadiff2i_17 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
        GIa2->Val = GIa1;
...
static Ptr GLsymbs_52() {       /* decrerr1 */
   {    register Ptr aRet;
        GIa2 = GMfdecr;
        {aRet = ((Ptr) GXerrnva); goto lRet;}
  lRet:  return (aRet);}}
