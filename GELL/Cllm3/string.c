...
static Ptr GLstring_1() {       /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_str); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_str() {        /* ini_str */
   {    register Ptr aRet;
...
static Ptr GLstring_2() {       /* ret_call_makestrg_1 */
   {    register Ptr aRet;
        GIa3 = (GIsp++)->Val;
        GIa3->Val = GIa1;
...
static Ptr GLstring_3() {       /* ret_call_makestrg_2 */
   {    register Ptr aRet;
        GIbufstrg = GIa1;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_4() {       /* strfalse */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXstrgallc() {       /* strgallc */
...
l_strgall0:
        GIa1 = GIfstrg;
        if (GIa1 == GInil)      {aRet = ((Ptr) GLstring_5); goto lRet;}
        GIocheap = GIcheap;
        GIcheap += 3 + (((Fix) (rA2)) / sizeof(Ptr));
        if (GIeheap < GIcheap)  {aRet = ((Ptr) GLstring_6); goto lRet;}
        {aRet = ((Ptr) GLstring_7); goto lRet;}
  lRet: GIa2 = rA2; return (aRet);}}

static Ptr GLstring_7() {       /* strgall2 */
...
static Ptr GLstring_5() {       /* strgall3 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXstrgallc);
        {aRet = ((Ptr) GXgcstrg); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_6() {       /* strgall4 */
   {    register Ptr aRet;
        GIa1 = GInil;
        GIcheap = GIocheap;
        (--GIsp)->Val = ((Ptr) GLstring_8);
        {aRet = ((Ptr) GXhgc); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_8() {       /* ret_call_hgc_4 */
   {    register Ptr aRet;
        GIa1 = GIfstrg;
        GIocheap = GIcheap;
        GIcheap += 3 + (((Fix) (GIa2)) / sizeof(Ptr));
        if (GIcheap < GIeheap)  {aRet = ((Ptr) GLstring_7); goto lRet;}
        GIcheap = GIocheap;
        GIa1 = GInil;
        {aRet = ((Ptr) GXerrfh); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgetnumi() {        /* getnumi */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        if (rA1 == (Ptr) ((UFix) 0x8000))       {aRet = ((Ptr) GLstring_9); goto lRet;}
        if ((Fix) (rA1) >= (Fix) 0)     {aRet = ((Ptr) GLstring_10); goto lRet;}
        GIa4 = (Ptr) 45;
        (--GIsp)->Val = ((Ptr) GLstring_11);
        {aRet = ((Ptr) GLstring_12); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_11() {      /* ret_call_getnumch_5 */
   {    register Ptr aRet;
        GIa1 = (Ptr) ((UFix) ((Fix) (0) - (Fix) (GIa1)));
        {aRet = ((Ptr) GLstring_10); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_10() {      /* getpos */
...
l_getpos2:
        ...
        if (rA1 == (Ptr) 0)     {aRet = ((Ptr) GLstring_12); goto lRet;}
        (--rSp)->Val = rA4;
        (--rSp)->Val = ((Ptr) GLstring_13);
        goto l_GLstring_10;
  lRet: GIsp = rSp; GIa1 = rA1; GIa4 = rA4; return (aRet);}}

static Ptr GLstring_13() {      /* ret_call_getpos_6 */
   {    register Ptr aRet;
        GIa4 = (GIsp++)->Val;
        {aRet = ((Ptr) GLstring_12); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_9() {       /* getmin */
   {    register Ptr aRet;
        GIa4 = (Ptr) 35;
...
static Ptr GLstring_14() {      /* ret_call_getnumch_7 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 36;
...
static Ptr GLstring_15() {      /* ret_call_getnumch_8 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 56;
...
static Ptr GLstring_16() {      /* ret_call_getnumch_9 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 48;
        (--GIsp)->Val = ((Ptr) GLstring_17);
        {aRet = ((Ptr) GLstring_12); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_17() {      /* ret_call_getnumch_10 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLstring_12);
        {aRet = ((Ptr) GLstring_12); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_12() {      /* getnumch */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
...
static Ptr GLstring_18() {      /* badstr2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLstring_19); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_19() {      /* badstr1 */
   {    register Ptr aRet;
        GIa2 = GIsavea4;
        {aRet = ((Ptr) GXerrnsa); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_20() {      /* badvec2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLstring_21); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_21() {      /* badvec1 */
   {    register Ptr aRet;
        GIa2 = GIsavea4;
        {aRet = ((Ptr) GXerrvec); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_22() {      /* badnbar5 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 5;
        {aRet = ((Ptr) GLstring_23); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_24() {      /* badnbar3 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 3;
        {aRet = ((Ptr) GLstring_23); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_23() {      /* badnba31 */
   {    register Ptr aRet;
        GIa2 = GIsavea4;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_25() {      /* badnbar4 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 4;
        {aRet = ((Ptr) GLstring_23); goto lRet;}
l_badoob1:
...
static Ptr GLstring_26() {      /* badfix2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLstring_27); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_27() {      /* badfix1 */
   {    register Ptr aRet;
        GIa2 = GIsavea4;
        {aRet = ((Ptr) GXerrnia); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_28() {      /* badfix3 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GLstring_27); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_29() {      /* badfix4 */
   {    register Ptr aRet;
        GIa1 = GIa4;
        {aRet = ((Ptr) GLstring_27); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_30() {      /* badind2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLstring_31); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_31() {      /* badind1 */
   {    register Ptr aRet;
        GIa2 = GIsavea4;
        {aRet = ((Ptr) GXerroob); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_32() {      /* badind3 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GLstring_31); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_33() {      /* badind4 */
   {    register Ptr aRet;
        GIa1 = GIa4;
        {aRet = ((Ptr) GLstring_31); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_34() {      /* mina1a2 */
...
static Ptr GLstring_35() {      /* mina1a3 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLstring_36() {      /* mina1a4 */
...
static Ptr GLstring_37() {      /* mina3a4 */
...
static Ptr GLstring_38() {      /* mina4a3 */
...
extern Ptr GXstring() { /* string */
   {    register Ptr aRet, rSp, rA1, rA2, rBstrg, rBsymb;
        ...
        if ((rA1 < rBsymb) || (rA1 >= GIbcons)) {aRet = ((Ptr) GLstring_39); goto lRet;}
        rA2 = (rA1 + 5)->Val;
...
extern Ptr GXstringa1() {       /* stringa1 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
extern Ptr GXstrgsymb() {       /* strgsymb */
   {    register Ptr aRet, rSp, rA1, rA2, rBstrg, rBsymb;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rBstrg = GIbstrg; rBsymb = GIbsymb;
        (--rSp)->Val = rA2;
        rA2 = (rA1 + 5)->Val;
...
static Ptr GLstring_39() {      /* strgrest */
   {    register Ptr aRet, rSp, rA1, rA2, rA3;
        ...
        if ((rA1 >= GIbvect) && (rA1 < GIbstrg))        {aRet = ((Ptr) GLstring_19); goto lRet;}
        (--rSp)->Val = rA2;
        (--rSp)->Val = rA3;
        rA3 = GIbufstrg;
...
static Ptr GLstring_41() {      /* strgnn */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        if (rA1 == GInil)       {aRet = ((Ptr) GLstring_42); goto lRet;}
        if ((long) rA1 < (long) GIbcons)        {aRet = ((Ptr) GLstring_19); goto lRet;}
        GIa4 = rA1->Val;
        if (GIa4 >= GIbfloat)   {aRet = ((Ptr) GLstring_19); goto lRet;}
        (--GIsp)->Val = ((Ptr) GLstring_43);
        {aRet = ((Ptr) GLstring_12); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_43() {      /* ret_call_getnumch_13 */
   {    register Ptr aRet;
        if ((Fix) (GIa2) >= (Fix) 1024) {aRet = ((Ptr) GLstring_19); goto lRet;}
        GIa1 = (GIa1 + 1)->Val;
        {aRet = ((Ptr) GLstring_41); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_42() {      /* strgfol4 */
   {    register Ptr aRet;
        GIa4 = (GIsp++)->Val;
        {aRet = ((Ptr) GLstring_40); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_40() {      /* strgfol */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLstring_44);
        {aRet = ((Ptr) GXstrgallc); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_44() {      /* ret_call_strgallc_14 */
...
extern Ptr GXstringa2() {       /* stringa2 */
...
static Ptr GLstring_45() {      /* ret_call_strgrest_15 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = GIa1;
        GIa1 = (rSp++)->Val;
...
static Ptr GLstring_46() {      /* stringa3 */
...
static Ptr GLstring_47() {      /* ret_call_strgrest_16 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa3 = GIa1;
        GIa1 = (rSp++)->Val;
...
static Ptr GLstring_48() {      /* ret_call_stringa1_17 */
   {    register Ptr aRet;
        GIa1 = (GIa1->Val + 1)->Val;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXslength() {        /* slength */
   {    register Ptr aRet;
        GIsavea4 = GMslength;
...
static Ptr GLstring_49() {      /* ret_call_stringa1_18 */
   {    register Ptr aRet;
        GIa1 = (GIa1->Val + 1)->Val;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXslen() {   /* slen */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIsavea4 = GMslen;
        if ((rA1 < GIbstrg) || (rA1 >= GIbsymb))        {aRet = ((Ptr) GLstring_19); goto lRet;}
        rA1 = (rA1->Val + 1)->Val;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa1 = rA1; return (aRet);}}

extern Ptr GXcaten() {  /* catenate */
   {    register Ptr aRet;
        GIsavea4 = GMcaten;
        {aRet = ((Ptr) GLstring_50); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_50() {      /* caten0 */
   {    register Ptr aRet;
        GIa3 = GIa4;
        GIa2 = (Ptr) 0;
...
static Ptr GLstring_53() {      /* ret_call_stringa1_19 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLstring_55() {      /* ret_call_strgallc_20 */
...
static Ptr GLstring_54() {      /* catenstl */
   {    register Ptr aRet;
        GIa1 = (Ptr) 32767;
        GIa2 = GMcaten;
...
extern Ptr GXsubsequal() {      /* substring-equal */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4, rBfloat, rBstrg, rBsymb;
        ...
        if (rA4 != (Ptr) 5)     {aRet = ((Ptr) GLstring_22); goto lRet;}
        rA1 = (rSp + 3)->Val;
        if ((rA1 < rBstrg) || (rA1 >= rBsymb))  {aRet = ((Ptr) GLstring_19); goto lRet;}
        rA2 = (rSp + 1)->Val;
        if ((rA2 < rBstrg) || (rA2 >= rBsymb))  {aRet = ((Ptr) GLstring_18); goto lRet;}
        rA3 = (rSp + 2)->Val;
        if (rA3 >= rBfloat)     {aRet = ((Ptr) GLstring_28); goto lRet;}
        if ((Fix) (rA3) < (Fix) 0)      {aRet = ((Ptr) GLstring_32); goto lRet;}
        rA4 = rSp->Val;
        if (rA4 >= rBfloat)     {aRet = ((Ptr) GLstring_29); goto lRet;}
        if ((Fix) (rA4) < (Fix) 0)      {aRet = ((Ptr) GLstring_33); goto lRet;}
        GIsavea1 = rA1;
        GIsavea2 = rA2;
        rA1 = (rSp + 4)->Val;
        if (rA1 >= rBfloat)     {aRet = ((Ptr) GLstring_27); goto lRet;}
        if ((Fix) (rA1) < (Fix) 0)      {aRet = ((Ptr) GLstring_31); goto lRet;}
        rA2 = rA1;
        rA2 = (Ptr) ((UFix) ((Fix) (rA2) + (Fix) (rA3)));
        GIsavea3 = (GIsavea1->Val + 1)->Val;
        if ((Fix) (rA2) > (Fix) (GIsavea3))     {aRet = ((Ptr) GLstring_31); goto lRet;}
        rA2 = rA1;
...
extern Ptr GXeqstring() {       /* eqstring */
   {    register Ptr aRet;
        GIsavea4 = GMeqstring;
...
static Ptr GLstring_57() {      /* ret_call_stringa1_21 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXeqstrgi);
        {aRet = ((Ptr) GXstringa2); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXeqstrgi() {        /* eqstrgi */
...
static Ptr GLstring_59() {      /* ret_call_equal_23 */
...
extern Ptr GXsubstring() {      /* substring */
   {    register Ptr aRet, rSp, rA1, rA4, rBfloat;
        ...
        if (rA4 != (Ptr) 3)     {aRet = ((Ptr) GLstring_24); goto lRet;}
        rA1 = (rSp++)->Val;
        if (rA1 >= rBfloat)     {aRet = ((Ptr) GLstring_27); goto lRet;}
l_substr1:
        rA4 = (rSp++)->Val;
...
static Ptr GLstring_61() {      /* ret_call_stringa3_24 */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        rA2 = (GIa3->Val + 1)->Val;
...
static Ptr GLstring_62() {      /* ret_call_mina1a2_25 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLstring_63);
        {aRet = ((Ptr) GXstrgallc); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_63() {      /* ret_call_strgallc_26 */
...
extern Ptr GXmakestrg() {       /* makestring */
   {    register Ptr aRet, rSp, rA1, rA2, rBfloat;
        ...
        rA1 = (Ptr) 0;
l_makstrg0:
        if (rA2 >= rBfloat)     {aRet = ((Ptr) GLstring_26); goto lRet;}
        (--rSp)->Val = rA2;
        rA2 = rA1;
...
static Ptr GLstring_64() {      /* ret_call_strgallc_27 */
...
extern Ptr GXduplstrg() {       /* duplstring */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIsavea4 = GMduplstrg;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
        if ((Fix) (rA1) < (Fix) 0)      {aRet = ((Ptr) GLstring_65); goto lRet;}
        (--GIsp)->Val = ((Ptr) GLstring_66);
        {aRet = ((Ptr) GXstringa2); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_66() {      /* ret_call_stringa2_28 */
   {    register Ptr aRet, rA1, rA2;
        rA1 = GIa1; rA2 = GIa2;
        GIa3 = rA2;
        GIa4 = (rA2->Val + 1)->Val;
...
static Ptr GLstring_68() {      /* ret_call_strgallc_29 */
...
static Ptr GLstring_65() {      /* dupserr */
   {    register Ptr aRet;
        GIa2 = GMduplstrg;
        {aRet = ((Ptr) GXerroob); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_67() {      /* dupsstl */
   {    register Ptr aRet;
        GIa2 = GMduplstrg;
        {aRet = ((Ptr) GXerrstl); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXbltstrg() {        /* bltstring */
...
l_bltstrg1:
        rA2 = (rSp++)->Val;
        if (rA2 >= rBfloat)     {aRet = ((Ptr) GLstring_26); goto lRet;}
        if ((Fix) (rA2) < (Fix) 0)      {aRet = ((Ptr) GLstring_30); goto lRet;}
l_bltstrg2:
        GIsavea2 = rA2;
        rA2 = (rSp++)->Val;
...
static Ptr GLstring_69() {      /* ret_call_stringa2_30 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = (rSp++)->Val;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
...
static Ptr GLstring_70() {      /* ret_call_mina1a3_31 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
        rA4 = (GIa2->Val + 1)->Val;
...
static Ptr GLstring_71() {      /* ret_call_mina4a3_32 */
   {    register Ptr aRet, rSp, rA3;
        rSp = GIsp; rA3 = GIa3;
        GIa1 = (rSp++)->Val;
...
extern Ptr GXfillstrg() {       /* fillstring */
   {    register Ptr aRet, rSp, rA1, rA2, rA4, rBfloat;
        ...
        if (rA4 != (Ptr) 4)     {aRet = ((Ptr) GLstring_25); goto lRet;}
        rA1 = (rSp++)->Val;
        if (rA1 >= rBfloat)     {aRet = ((Ptr) GLstring_27); goto lRet;}
l_fillstr0:
        GIa3 = (rSp++)->Val;
        if (GIa3 >= rBfloat)    {aRet = ((Ptr) GLstring_28); goto lRet;}
        rA2 = (rSp++)->Val;
        if (rA2 >= rBfloat)     {aRet = ((Ptr) GLstring_26); goto lRet;}
        if ((Fix) (rA2) < (Fix) 0)      {aRet = ((Ptr) GLstring_30); goto lRet;}
        rA4 = rA1;
...
static Ptr GLstring_72() {      /* ret_call_mina1a4_33 */
...
extern Ptr GXscanstrg() {       /* scanstring */
   {    register Ptr aRet;
        GIsavea4 = GMscanstrg;
        {aRet = ((Ptr) GLstring_73); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_73() {      /* sanstrg1 */
   {    register Ptr aRet, rSp, rA3, rA4;
        rSp = GIsp; rA3 = GIa3; rA4 = GIa4;
        rA3 = (Ptr) 0;
        ...
        if (rA4 != (Ptr) 3)     {aRet = ((Ptr) GLstring_24); goto lRet;}
        rA3 = (rSp++)->Val;
        if (rA3 >= GIbfloat)    {aRet = ((Ptr) GLstring_28); goto lRet;}
        if ((Fix) (rA3) < (Fix) 0)      {aRet = ((Ptr) GLstring_32); goto lRet;}
l_sanstrg2:
        GIa2 = (rSp++)->Val;
...
static Ptr GLstring_74() {      /* ret_call_stringa2_34 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
...
static Ptr GLstring_75() {      /* ret_call_stringa1_35 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4;
        rA4 = (rA1->Val + 1)->Val;
        {register int aux;
...
extern Ptr GXspanstrg() {       /* spanstring */
   {    register Ptr aRet;
        GIsavea4 = GMspanstrg;
        {aRet = ((Ptr) GLstring_73); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXchrpos() { /* chrpos */
   {    register Ptr aRet, rSp, rA3, rA4;
        rSp = GIsp; rA3 = GIa3; rA4 = GIa4;
        GIsavea4 = GMchrpos;
        rA3 = (Ptr) 0;
...
static Ptr GLstring_76() {      /* ret_call_stringa2_36 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4;
        rA1 = (rSp++)->Val;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
...
extern Ptr GXsref() {   /* sref */
   {    register Ptr aRet, rA1, rA2;
        rA1 = GIa1; rA2 = GIa2;
        GIsavea4 = GMsref;
        if ((rA1 < GIbstrg) || (rA1 >= GIbsymb))        {aRet = ((Ptr) GLstring_19); goto lRet;}
        if (rA2 >= GIbfloat)    {aRet = ((Ptr) GLstring_26); goto lRet;}
        if ((Fix) (rA2) < (Fix) 0)      {aRet = ((Ptr) GLstring_30); goto lRet;}
        GIa3 = (rA1->Val + 1)->Val;
        if ((Fix) (rA2) >= (Fix) (GIa3))        {aRet = ((Ptr) GLstring_30); goto lRet;}
        rA1 = (Ptr) ((unsigned char) *(((char *) (rA1->Val + 2)) + (Fix) (rA2)));
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa1 = rA1; return (aRet);}}

extern Ptr GXchrnth() { /* chrnth */
   {    register Ptr aRet;
        GIsavea4 = GMchrnth;
...
static Ptr GLstring_77() {      /* ret_call_stringa2_37 */
   {    register Ptr aRet, rA1, rA2;
        rA1 = GIa1; rA2 = GIa2;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
        if ((Fix) (rA1) < (Fix) 0)      {aRet = ((Ptr) GLstring_4); goto lRet;}
        GIa3 = (rA2->Val + 1)->Val;
        if ((Fix) (rA1) >= (Fix) (GIa3))        {aRet = ((Ptr) GLstring_4); goto lRet;}
        rA1 = (Ptr) ((unsigned char) *(((char *) (rA2->Val + 2)) + (Fix) (rA1)));
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa1 = rA1; return (aRet);}}

extern Ptr GXsset() {   /* sset */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        GIsavea4 = GMsset;
        GIa4 = GIa1;
        GIa1 = rA2;
        rA2 = GIa4;
        if ((rA2 < GIbstrg) || (rA2 >= GIbsymb))        {aRet = ((Ptr) GLstring_18); goto lRet;}
        (--rSp)->Val = GIa3;
        (--rSp)->Val = ((Ptr) GLstring_78);
        {aRet = ((Ptr) GLstring_79); goto lRet;}
  lRet: GIsp = rSp; GIa2 = rA2; return (aRet);}}

static Ptr GLstring_78() {      /* ret_call_chrset5_38 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLstring_79() {      /* chrset5 */
   {    register Ptr aRet, rA1, rA2, rA3, rBfloat;
        ...
        if (rA3 >= rBfloat)     {aRet = ((Ptr) GLstring_28); goto lRet;}
        GIa4 = (rA2->Val + 1)->Val;
        if ((Fix) (rA1) >= (Fix) (GIa4))        {aRet = ((Ptr) GLstring_31); goto lRet;}
        *((char *) (rA2->Val + 2) + (Fix) (rA1)) = (char) rA3;
        rA1 = rA3;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa1 = rA1; return (aRet);}}

extern Ptr GXtypestrg() {       /* typestring */
...
extern Ptr GXexchstrg() {       /* exchstring */
   {    register Ptr aRet, rSp, rA1, rA2, rBstrg, rBsymb;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rBstrg = GIbstrg; rBsymb = GIbsymb;
        GIsavea4 = GMexchstrg;
        if ((rA1 < rBstrg) || (rA1 >= rBsymb))  {aRet = ((Ptr) GLstring_19); goto lRet;}
...
static Ptr GLstring_80() {      /* ret_call_stringa2_40 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
...
static Ptr GLstring_81() {      /* ret_call_stringa1_41 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4;
        rA4 = (rA2->Val + 1)->Val;
...
extern Ptr GXalphales() {       /* alphalessp */
   {    register Ptr aRet;
        GIsavea4 = GMalphales;
...
static Ptr GLstring_83() {      /* ret_call_stringa1_42 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLstring_84);
        {aRet = ((Ptr) GXstringa2); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_84() {      /* ret_call_stringa2_43 */
   {    register Ptr aRet;
        GIa3 = (GIa1->Val + 1)->Val;
        GIa4 = (GIa2->Val + 1)->Val;
...
static Ptr GLstring_85() {      /* ret_call_mina3a4_44 */
...
l_alpha1:
        ...
        if (GIsavea1 != GIsavea2)       {aRet = ((Ptr) GLstring_4); goto lRet;}
        rA3 = (Ptr) ((UFix) ((Fix) (rA3) + (Fix) (1)));
l_alpha2:
        {register Fix aux;
                aux = (Fix) (rA4) - 1;
        ...
        rA4 = (rA1->Val + 1)->Val;
        if (rA4 != rA3) {aRet = ((Ptr) GLstring_4); goto lRet;}
l_strue:
        rA1 = GMt;
        {aRet = (rSp++)->Val; goto lRet;}
  lRet: GIsp = rSp; GIa1 = rA1; GIa3 = rA3; GIa4 = rA4; return (aRet);}}

extern Ptr GXffsymbol() {       /* symbol */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
...
static Ptr GLstring_86() {      /* ret_call_stringa2_45 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLstring_87() {      /* concat9 */
   {    register Ptr aRet;
        GIa2 = GIa1;
        GIa1 = GInil;
        (--GIsp)->Val = GIsavea2;
...
static Ptr GLstring_88() {      /* ret_call_stringa1_47 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4;
        rA2 = (rA1->Val + 1)->Val;
        rA3 = rA1;
...
extern Ptr GXrdpscrn() {        /* rdpscrn */
   {    register Ptr aRet;
        GIsavea4 = GMtyrdspl;
        {aRet = ((Ptr) GLstring_89); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_90() {      /* rdpscrn1 */
   {    register Ptr aRet, rSp, rA3, rA4;
        rSp = GIsp; rA3 = GIa3; rA4 = GIa4;
        {register char *r1, *r2; register int r3;
                r1 = (char *) (GIsavea1->Val + 2);
...
static Ptr GLstring_93() {      /* rdpscrn3 */
...
static Ptr GLstring_95() {      /* rdpscrn4 */
   {    register Ptr aRet, rSp, rA3, rA4;
        rSp = GIsp; rA3 = GIa3; rA4 = GIa4;
        rA3 = (Ptr) ((UFix) ((Fix) (rA3) + (Fix) (1)));
        {register Fix aux;
...
static Ptr GLstring_92() {      /* rdpscrn5 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLstring_94() {      /* scrnaff */
   {    register Ptr aRet, rSp, rA3;
        rSp = GIsp; rA3 = GIa3;
        (--rSp)->Val = GIsavea1;
        (--rSp)->Val = GIsavea2;
...
static Ptr GLstring_98() {      /* scrnaff1 */
   {    register Ptr aRet;
        (--GIsp)->Val = GIa1;
        {aRet = ((Ptr) GXtyo); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_96() {      /* scrnaff3 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa3 = (rSp++)->Val;
        GIa4 = (rSp++)->Val;
...
static Ptr GLstring_97() {      /* scrnaff4 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3;
        rA2 = (rSp + 1)->Val;
        rA2 = (Ptr) ((UFix) ((Fix) (rA2) - (Fix) (1)));
...
static Ptr GLstring_99() {      /* ret_call_tycursor_48 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 1;
        {aRet = ((Ptr) GXtyo); goto lRet;}
...
static Ptr GLstring_100() {     /* clipscrn */
...
static Ptr GLstring_101() {     /* mina1dlx */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLstring_102() {     /* mina1dly */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
extern Ptr GXbltscrn() {        /* bltscreen */
   {    register Ptr aRet;
        GIsavea4 = GMbltscrn;
        {aRet = ((Ptr) GLstring_89); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_89() {      /* bltscrn0 */
   {    register Ptr aRet, rSp, rA1, rA2, rA4, rBfloat;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA4 = GIa4; rBfloat = GIbfloat;
        rA1 = (rSp++)->Val;
...
static Ptr GLstring_104() {     /* ret_call_clipscrn_49 */
...
static Ptr GLstring_105() {     /* ret_call_clipscrn_50 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIyr = GIa3;
        rA1 = (rSp++)->Val;
...
static Ptr GLstring_106() {     /* ret_call_mina1dly_51 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = (rSp++)->Val;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
        GIws = rA1;
        rA1 = (Ptr) ((UFix) ((Fix) (rA1) - (Fix) (GIis)));
        (--rSp)->Val = ((Ptr) GLstring_107);
        {aRet = ((Ptr) GLstring_101); goto lRet;}
  lRet: GIsp = rSp; GIa1 = rA1; return (aRet);}}

static Ptr GLstring_107() {     /* ret_call_mina1dlx_52 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = (rSp++)->Val;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
...
static Ptr GLstring_108() {     /* ret_call_mina1dly_53 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = (rSp++)->Val;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
        GIwd = rA1;
        rA1 = (Ptr) ((UFix) ((Fix) (rA1) - (Fix) (GIid)));
        (--rSp)->Val = ((Ptr) GLstring_103);
        {aRet = ((Ptr) GLstring_101); goto lRet;}
  lRet: GIsp = rSp; GIa1 = rA1; return (aRet);}}

static Ptr GLstring_103() {     /* bltscrnb */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4, rBstrg, rBsymb;
        ...
        GIis = (Ptr) ((UFix) ((Fix) (GIis) + (Fix) (rA4)));
        rA4 = GIdly;
        rA3 = (Ptr) ((UFix) ((Fix) (rA3) * (Fix) (GIwd)));
        rA3 = (Ptr) ((UFix) ((Fix) (rA3) + (Fix) (GIid)));
...
extern Ptr GXtypevect() {       /* typevector */
...
extern Ptr GXmakevect() {       /* makevector */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIsavea4 = GMmakevect;
        if (rA1 >= GIbfloat)    {aRet = ((Ptr) GLstring_27); goto lRet;}
...
static Ptr GLstring_109() {     /* makvect0 */
   {    register Ptr aRet;
        GIa1 = GIfvect;
...
static Ptr GLstring_112() {     /* makvect2 */
   {    register Ptr aRet, rSp, rA1, rA3;
        rSp = GIsp; rA1 = GIa1; rA3 = GIa3;
        GIfvect = rA1->Val;
        rA1->Val = GIocheap;
...
static Ptr GLstring_110() {     /* makvect3 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLstring_109);
        {aRet = ((Ptr) GXgcvect); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLstring_111() {     /* makvect4 */
   {    register Ptr aRet;
        GIa1 = GInil;
        GIcheap = GIocheap;
...
static Ptr GLstring_113() {     /* ret_call_hgc_56 */
   {    register Ptr aRet;
        GIa1 = GIfvect;
        GIocheap = GIcheap;
        GIcheap = (GIcheap + 2 + (Fix) (GIa3));
...
extern Ptr GXvlength() {        /* vlength */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIsavea4 = GMvlength;
        if ((rA1 < GIbvect) || (rA1 >= GIbstrg))        {aRet = ((Ptr) GLstring_21); goto lRet;}
        rA1 = (rA1->Val + 1)->Val;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa1 = rA1; return (aRet);}}

extern Ptr GXeqvector() {       /* eqvector */
   {    register Ptr aRet, rA1, rA2, rBvect, rBstrg;
        rA1 = GIa1; rA2 = GIa2; rBvect = GIbvect; rBstrg = GIbstrg;
        GIsavea4 = GMeqvector;
        if ((rA1 < rBvect) || (rA1 >= rBstrg))  {aRet = ((Ptr) GLstring_21); goto lRet;}
        if ((rA2 < rBvect) || (rA2 >= rBstrg))  {aRet = ((Ptr) GLstring_20); goto lRet;}
        {aRet = ((Ptr) GXeqvectri); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXeqvectri() {       /* eqvectri */
   {    register Ptr aRet, rA1, rA2, rA4;
        rA1 = GIa1; rA2 = GIa2; rA4 = GIa4;
        GIa3 = (rA1->Val + 1)->Val;
        rA4 = (rA2->Val + 1)->Val;
        if (GIa3 != rA4)        {aRet = ((Ptr) GLstring_4); goto lRet;}
        rA4 = (rA1 + 1)->Val;
        if ((rA4 < GIbsymb) || (rA4 >= GIbcons))        {aRet = ((Ptr) GLstring_114); goto lRet;}
        if (rA4 != (rA2 + 1)->Val)      {aRet = ((Ptr) GLstring_4); goto lRet;}
        {aRet = ((Ptr) GLstring_115); goto lRet;}
  lRet: GIa4 = rA4; return (aRet);}}

static Ptr GLstring_116() {     /* eqvect4 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3;
        (--rSp)->Val = rA1;
        (--rSp)->Val = rA2;
...
static Ptr GLstring_117() {     /* ret_call_equal_57 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = GIa1;
        GIa3 = (rSp++)->Val;
        GIa2 = (rSp++)->Val;
        GIa1 = (rSp++)->Val;
        if (GIa4 == GInil)      {aRet = ((Ptr) GLstring_4); goto lRet;}
        {aRet = ((Ptr) GLstring_115); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLstring_115() {     /* eqvect5 */
   {    register Ptr aRet;
        {register Fix aux;
                aux = (Fix) (GIa3) - 1;
                GIa3 = (Ptr) ((UFix) aux);
...
static Ptr GLstring_114() {     /* eqvect6 */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        (--rSp)->Val = GIa1;
        (--rSp)->Val = rA2;
...
static Ptr GLstring_118() {     /* ret_call_equal_58 */
   {    register Ptr aRet, rSp, rA1, rNil;
        rSp = GIsp; rA1 = GIa1; rNil = GInil;
        GIa4 = rA1;
        GIa3 = (rSp++)->Val;
...
extern Ptr GXvset() {   /* vset */
   {    register Ptr aRet, rA1, rA2, rA3;
        ...
        if ((rA1 < GIbvect) || (rA1 >= GIbstrg))        {aRet = ((Ptr) GLstring_21); goto lRet;}
        GIa4 = (rA1->Val + 1)->Val;
        if ((Fix) (rA2) >= (Fix) (GIa4))        {aRet = ((Ptr) GLstring_30); goto lRet;}
        (rA1->Val + 2 + (Fix) (rA2))->Val = rA3;
        rA1 = rA3;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa1 = rA1; return (aRet);}}

extern Ptr GXbltvect() {        /* bltvector */
...
static Ptr GLstring_119() {     /* ret_call_mina1a3_59 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
        rA4 = (GIa2->Val + 1)->Val;
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (GIsavea2)));
...
static Ptr GLstring_120() {     /* ret_call_mina4a3_60 */
   {    register Ptr aRet, rSp, rA3;
        rSp = GIsp; rA3 = GIa3;
        GIa1 = (rSp++)->Val;
        if ((Fix) (rA3) <= (Fix) 0)     { aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLstring_121() {     /* ret_call_makevect_61 */
   {    register Ptr aRet, rSp, rA2, rA4;
        rSp = GIsp; rA2 = GIa2; rA4 = GIa4;
        rA4 = (rSp++)->Val;
        goto l_vector2;
...
extern Ptr GXexchvect() {       /* exchvector */
...
extern Ptr GXfillvect() {       /* fillvector */
   {    register Ptr aRet, rSp, rA1, rA2, rA4, rBfloat;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA4 = GIa4; rBfloat = GIbfloat;
        GIsavea4 = GMfillvect;
        rA1 = (Ptr) 32767;
...
static Ptr GLstring_122() {     /* ret_call_mina1a4_62 */
   {    register Ptr aRet, rSp, rA1, rA2, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA4 = GIa4;
        rA1 = (rSp++)->Val;
        goto l_fillvec8;
