...
static Ptr GLspecnb_1() {       /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_snb); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_snb() {        /* ini_snb */
   {    register Ptr aRet;
        ...
        { llrt_inisymb ((Ptr) 6, (Ptr) "random", ((Ptr) GXrandom), (Ptr) &GMrandom, (Ptr) GFrandom);}
        { llrt_inisymb ((Ptr) 7, (Ptr) "srandom", ((Ptr) GXsrandom), (Ptr) &GMsrandom, (Ptr) GFsrandom);}
        ...
        { llrt_inisymb ((Ptr) 3, (Ptr) "div", ((Ptr) GXlldiv), (Ptr) &GMlldiv, (Ptr) GFlldiv);}
...
static Ptr GLspecnb_2() {       /* nfalse */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_3() {       /* rzero */
...
static Ptr GLspecnb_4() {       /* banfix3 */
   {    register Ptr aRet;
        GIa2 = GIa3;
        {aRet = ((Ptr) GLspecnb_5); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_5() {       /* banfix2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLspecnb_6); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_6() {       /* banfix1 */
   {    register Ptr aRet;
        GIa2 = GIa4;
        {aRet = ((Ptr) GXerrnia); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_7() {       /* banflt2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLspecnb_8); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_8() {       /* banflt1 */
   {    register Ptr aRet;
        GIa2 = GIa4;
        {aRet = ((Ptr) GXerrnfa); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_9() {       /* banmix2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLspecnb_10); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_10() {      /* banmix1 */
   {    register Ptr aRet;
        GIa2 = GIa4;
        {aRet = ((Ptr) GXerrnna); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_11() {      /* ban0dv */
   {    register Ptr aRet;
        GIa2 = GIa4;
        GIa1 = (Ptr) 0;
...
extern Ptr GXlogshift() {       /* logshift */
   {    register Ptr aRet, rA1, rA2, rBfloat;
        rA1 = GIa1; rA2 = GIa2; rBfloat = GIbfloat;
        GIa4 = GMlogshift;
        if (rA1 >= rBfloat)     {aRet = ((Ptr) GLspecnb_6); goto lRet;}
...
extern Ptr GXmskfield() {       /* mask-field */
   {    register Ptr aRet;
        GIa4 = GMmskfield;
        {aRet = ((Ptr) GLspecnb_13); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLspecnb_13() {      /* mskf0 */
...
extern Ptr GXldbt() {   /* load-byte-test */
   {    register Ptr aRet, rA1, rA2, rA3, rA4, rBfloat;
        rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4; rBfloat = GIbfloat;
        rA4 = GMldbt;
        if (rA1 >= rBfloat)     {aRet = ((Ptr) GLspecnb_6); goto lRet;}
...
extern Ptr GXdpbyte() { /* deposit-byte */
   {    register Ptr aRet;
        GIa3 = GIa4;
        GIa4 = GMdpbyte;
...
extern Ptr GXdpfield() {        /* deposit-field */
   {    register Ptr aRet;
        GIa3 = GIa4;
        GIa4 = GMdpfield;
        {aRet = ((Ptr) GLspecnb_14); goto lRet;}
...
static Ptr GLspecnb_15() {      /* ret_call_mskf0_1 */
...
extern Ptr GXclllsht() {        /* #:gell:logshift */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        {register Fix aux;
                aux = (Fix) (rSp->Val);
...
extern Ptr GXcllfadd() {        /* #:gell:fadd */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
extern Ptr GXcllfsub() {        /* #:gell:fsub */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
extern Ptr GXcllfmul() {        /* #:gell:fmul */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
extern Ptr GXcllfdiv() {        /* #:gell:fdiv */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLspecnb_16() {      /* cllret1 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (rSp + 2)->Val = (Ptr) 1;
        rSp += (Fix) 1;
...
extern Ptr GXcllfeqn() {        /* #:gell:feqn */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
extern Ptr GXcllfneqn() {       /* #:gell:fneqn */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
extern Ptr GXfldiff() { /* difference */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4, rBfloat;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4; rBfloat = GIbfloat;
...
static Ptr GDspecnb_61() {      /* trace #:gell:fadd */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,50,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_62() {      /* trace #:gell:fsub */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,51,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_63() {      /* trace #:gell:fmul */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,52,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_64() {      /* trace #:gell:fdiv */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,53,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_65() {      /* trace #:gell:feqn */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,54,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_66() {      /* trace #:gell:fneqn */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,55,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_67() {      /* trace #:gell:fgt */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,56,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_68() {      /* trace #:gell:fge */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,57,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_69() {      /* trace #:gell:flt */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,58,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_70() {      /* trace #:gell:fle */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,59,1,49);
  lRet:  return (aRet);}}

static Ptr GDspecnb_71() {      /* trace floatp */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,60,1,2);
  lRet:  return (aRet);}}

static Ptr GDspecnb_72() {      /* trace fixp */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,61,1,2);
  lRet:  return (aRet);}}

static Ptr GDspecnb_73() {      /* trace plus */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,62,1,23);
  lRet:  return (aRet);}}

static Ptr GDspecnb_74() {      /* trace difference */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,63,1,23);
  lRet:  return (aRet);}}

static Ptr GDspecnb_75() {      /* trace times */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,64,1,23);
  lRet:  return (aRet);}}

static Ptr GDspecnb_76() {      /* trace divide */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,65,1,5);
  lRet:  return (aRet);}}

static Ptr GDspecnb_77() {      /* trace ex+ */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,66,1,5);
  lRet:  return (aRet);}}

static Ptr GDspecnb_78() {      /* trace ex1+ */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,67,1,2);
  lRet:  return (aRet);}}

static Ptr GDspecnb_79() {      /* trace ex- */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,68,1,2);
  lRet:  return (aRet);}}

static Ptr GDspecnb_80() {      /* trace ex* */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,69,1,21);
  lRet:  return (aRet);}}

static Ptr GDspecnb_81() {      /* trace ex/ */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,70,1,5);
  lRet:  return (aRet);}}

static Ptr GDspecnb_82() {      /* trace ex? */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYspecnb,71,1,5);
  lRet:  return (aRet);}}
