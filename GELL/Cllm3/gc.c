...
static Ptr GLgc_1() {   /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_gc); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_gc() { /* ini_gc */
   {    register Ptr aRet;
...
static Ptr GLgc_3() {   /* ret_call_gcgo_1 */
...
static Ptr GLgc_7() {   /* ret_call_gcgo_5 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLgc_8() {   /* ret_call_gcgo_6 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
...
static Ptr GLgc_9() {   /* ret_call_itsoft_7 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLgc_10);
        {aRet = ((Ptr) GLgc_11); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_10() {  /* ret_call_gcnoit_8 */
   {    register Ptr aRet;
        GIa1 = GMgcalarm;
        GIa2 = GInil;
...
static Ptr GLgc_12() {  /* ret_call_itsoft_9 */
...
static Ptr GLgc_15() {  /* ret_call_sysprot_10 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        GIitstate = (Ptr) 1;
        {aRet = GIa3; goto lRet;}
...
static Ptr GLgc_14() {  /* gcst00 */
   {    register Ptr aRet;
        GIitstate = (Ptr) 0;
        {aRet = ((Ptr) GLgc_13); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_13() {  /* gcst0 */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXgcstmrk); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgcstmrk() {        /* gcstmrk */
   {    register Ptr aRet;
        GIa4 = GIsp;
        GIa3 = GIbstack;
...
static Ptr GLgc_17() {  /* ret_call_mark_11 */
...
static Ptr GLgc_23() {  /* gcat2 */
   {    register Ptr aRet;
        GIa4 = (GIa4 + 7)->Val;
        {aRet = ((Ptr) GLgc_22); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_22() {  /* gcat5 */
   {    register Ptr aRet;
        GIa1 = GIa4->Val;
...
static Ptr GLgc_29() {  /* ret_call_mark_17 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLgc_40() {  /* gcmark_gc_32 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GLgc_18); goto lRet;}
...
static Ptr GLgc_39() {  /* gcmark_gc_36 */
...
static Ptr GLgc_42() {  /* gcmark_gc_37 */
...
static Ptr GLgc_44() {  /* call_gc_43 */
   {    register Ptr aRet;
        GIa3 = (GIsp++)->Val;
        {aRet = ((Ptr) GLgc_41); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_41() {  /* gcmark_gc_38 */
...
l_hsweep2:
        ...
        llrt_llovni(GIbheap,GIcheap,GIeheap,GIoswheap);
        goto l_gcsweep;
l_hsweep4:
        GIoswheap = rA3;
        rA2 = (rA3 + 1)->Val;
...
extern Ptr GXgcswcons() {       /* gcswcons */
...
static Ptr GLgc_54() {  /* ret_call_gcgo_18 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        rA1 = (rSp++)->Val;
        if (rA1 != GInil)       {aRet = ((Ptr) GLgc_55); goto lRet;}
        rA1 = GMt;
        {aRet = (rSp++)->Val; goto lRet;}
  lRet: GIsp = rSp; GIa1 = rA1; return (aRet);}}

extern Ptr GXgcalarb() {        /* gc-before-alarm */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgcalarm() {        /* gcalarm */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgcinfo() { /* gcinfo */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
        if (rA4 == (Ptr) 0)     {aRet = ((Ptr) GLgc_55); goto lRet;}
        if (rA4 == (Ptr) 1)     {aRet = ((Ptr) GLgc_56); goto lRet;}
        GIa1 = (Ptr) 1;
        GIa2 = GMgcinfo;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_55() {  /* gcinfo0 */
   {    register Ptr aRet;
        GIa4 = GInil;
        {aRet = ((Ptr) GLgc_57); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_57() {  /* gcinfou */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GMgcuser;
        (--rSp)->Val = GIngccons;
        ...
        GIa2 = GIfreelm;
        (--rSp)->Val = ((Ptr) GLgc_58);
        {aRet = ((Ptr) GLgc_59); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLgc_58() {  /* ret_call_gcinfz_19 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        (--rSp)->Val = GMffsymbol;
...
static Ptr GLgc_60() {  /* ret_call_gcinfz_20 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        (--rSp)->Val = GMstring;
...
static Ptr GLgc_61() {  /* ret_call_gcinfz_21 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        (--rSp)->Val = GMvector;
...
static Ptr GLgc_62() {  /* ret_call_gcinfz_22 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        (--rSp)->Val = GMllfloat;
...
static Ptr GLgc_63() {  /* ret_call_gcinfz_23 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        (--rSp)->Val = GMllfix;
...
extern Ptr GXfrcons() { /* freecons */
   {    register Ptr aRet;
        if (GIitstate == (Ptr) 0)       {aRet = ((Ptr) GLgc_71); goto lRet;}
        GIa3 = ((Ptr) GLgc_72);
        (--GIsp)->Val = ((Ptr) GLgc_73);
        {aRet = ((Ptr) GXsysprot); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_73() {  /* ret_call_sysprot_25 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        GIitstate = (Ptr) 1;
        {aRet = GIa3; goto lRet;}
...
static Ptr GLgc_72() {  /* frcs0 */
   {    register Ptr aRet;
        GIitstate = (Ptr) 0;
        {aRet = ((Ptr) GLgc_71); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_71() {  /* frcs1 */
...
extern Ptr GXfrtree() { /* freetree */
   {    register Ptr aRet;
        if (GIitstate == (Ptr) 0)       {aRet = ((Ptr) GLgc_74); goto lRet;}
        GIa3 = ((Ptr) GLgc_75);
        (--GIsp)->Val = ((Ptr) GLgc_76);
        {aRet = ((Ptr) GXsysprot); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_76() {  /* ret_call_sysprot_26 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        GIitstate = (Ptr) 1;
        {aRet = GIa3; goto lRet;}
...
static Ptr GLgc_75() {  /* frtr0 */
   {    register Ptr aRet;
        GIitstate = (Ptr) 0;
        {aRet = ((Ptr) GLgc_74); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_74() {  /* frtr1 */
   {    register Ptr aRet;
        GIa4 = GIfcons;
...
static Ptr GLgc_77() {  /* ret_call_frtr3_27 */
...
static Ptr GLgc_79() {  /* frtr2 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GLgc_78); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_78() {  /* frtr3 */
...
l_frtr4:
        ...
        {register TableElem aux, mask;
                ...
                GIbtbin[aux] &= ~mask;}
        rA4 = rA1;
        if ((long) rA2 < (long) rBcons) {aRet = ((Ptr) GLgc_79); goto lRet;}
        (--rSp)->Val = rA3;
        rA1 = rA2;
        (--rSp)->Val = ((Ptr) GLgc_80);
        goto l_frtr4;
...
static Ptr GLgc_80() {  /* ret_call_frtr4_28 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GLgc_78); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXgettype() {        /* type-of */
...
extern Ptr GXtypep() {  /* typep */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXsubtypep);
        {aRet = ((Ptr) GXgettype); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXsubtypep() {       /* subtypep */
   {    register Ptr aRet, rSp, rA1, rA2, rBsymb, rBcons;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rBsymb = GIbsymb; rBcons = GIbcons;
        if ((rA1 < rBsymb) || (rA1 >= rBcons))  {aRet = ((Ptr) GLgc_81); goto lRet;}
        if ((rA2 < rBsymb) || (rA2 >= rBcons))  {aRet = ((Ptr) GLgc_82); goto lRet;}
        goto l_subtyp1;
l_subtyp0:
        rA1 = (rA1 + 3)->Val;
l_subtyp1:
        if (rA1 == rA2) goto l_subtyp3;
        if ((long) rA1 >= (long) rBcons)        {aRet = ((Ptr) GLgc_83); goto lRet;}
        if ((rA1 < rBsymb) || (rA1 >= rBcons))  { aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLgc_84() {  /* subtyp4 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        if ((long) GIa1 < (long) GIbcons)       {aRet = ((Ptr) GLgc_85); goto lRet;}
        {aRet = ((Ptr) GLgc_83); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_83() {  /* subtyp5 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = (rA1 + 1)->Val;
        rA1 = rA1->Val;
...
static Ptr GLgc_86() {  /* ret_call_subtyp7_29 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        if (GIa1 == GInil)      {aRet = ((Ptr) GLgc_84); goto lRet;}
        rSp += (Fix) 1;
        {aRet = (rSp++)->Val; goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLgc_87() {  /* subtyp6 */
   {    register Ptr aRet;
        GIa1 = (GIa1 + 3)->Val;
        {aRet = ((Ptr) GLgc_85); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_85() {  /* subtyp7 */
   {    register Ptr aRet, rSp, rA1, rBcons;
        rSp = GIsp; rA1 = GIa1; rBcons = GIbcons;
        if (rA1 == GIa2)        goto l_subtyp9;
        if ((long) rA1 >= (long) rBcons)        {aRet = ((Ptr) GLgc_83); goto lRet;}
        if ((rA1 < GIbsymb) || (rA1 >= rBcons)) { aRet = (rSp++)->Val; goto lRet;}
        if (rA1 != GInil)       {aRet = ((Ptr) GLgc_87); goto lRet;}
l_subtyp8:
        {aRet = (rSp++)->Val; goto lRet;}
l_subtyp9:
        rA1 = GMt;
...
static Ptr GLgc_82() {  /* subtypr2 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLgc_81); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_81() {  /* subtypr1 */
   {    register Ptr aRet;
        GIa2 = GMsubtypep;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXllsend() { /* send */
   {    register Ptr aRet, rA1, rA4;
        rA1 = GIa1; rA4 = GIa4;
        if ((Fix) (rA4) <= (Fix) 1)     {aRet = ((Ptr) GLgc_88); goto lRet;}
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
        rA1 = (GIsp + (Fix) (rA4))->Val;
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) + (Fix) (1)));
        if ((rA1 < GIbvect) || (rA1 >= GIbstrg))        {aRet = ((Ptr) GLgc_89); goto lRet;}
        rA1 = (rA1 + 1)->Val;
        {aRet = ((Ptr) GLgc_90); goto lRet;}
  lRet: GIa1 = rA1; GIa4 = rA4; return (aRet);}}

static Ptr GLgc_90() {  /* send1 */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
...
static Ptr GLgc_91() {  /* ret_call_getfns_30 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa4 = (rSp++)->Val;
        if (GIa1 == GInil)      {aRet = ((Ptr) GLgc_92); goto lRet;}
        (rSp + (Fix) (GIa4))->Val = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GXffuncall); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLgc_89() {  /* send2 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLgc_90);
        {aRet = ((Ptr) GXgettype); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_92() {  /* send3 */
...
extern Ptr GXsenderro() {       /* send-error */
   {    register Ptr aRet;
...
extern Ptr GXcsend() {  /* csend */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
        if ((Fix) (rA4) <= (Fix) 2)     {aRet = ((Ptr) GLgc_93); goto lRet;}
        (--rSp)->Val = ((Ptr) GLgc_94);
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
...
static Ptr GLgc_95() {  /* ret_call_getfns_32 */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
        rA4 = (rSp++)->Val;
...
extern Ptr GXsupsend() {        /* send-super */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
        if ((Fix) (rA4) <= (Fix) 2)     {aRet = ((Ptr) GLgc_96); goto lRet;}
        (--rSp)->Val = rA4;
        GIa2 = (rSp + (Fix) (rA4))->Val;
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) 2));
        GIa1 = (rSp + (Fix) (rA4))->Val;
...
static Ptr GLgc_97() {  /* ret_call_typep_33 */
   {    register Ptr aRet, rSp, rA1, rA4;
        rSp = GIsp; rA1 = GIa1; rA4 = GIa4;
        if (rA1 == GInil)       {aRet = ((Ptr) GLgc_98); goto lRet;}
        rA4 = (rSp++)->Val;
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
        rA1 = (rSp + (Fix) (rA4))->Val;
        if ((rA1 < GIbsymb) || (rA1 >= GIbcons))        {aRet = ((Ptr) GLgc_99); goto lRet;}
        rA1 = (rA1 + 3)->Val;
        (rSp + (Fix) (rA4))->Val = ((Ptr) GXpopj0);
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
        {aRet = ((Ptr) GLgc_90); goto lRet;}
...
static Ptr GLgc_99() {  /* supsenr2 */
   {    register Ptr aRet;
        GIa2 = GMsupsend;
        {aRet = ((Ptr) GXerrsym); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_98() {  /* supsenr3 */
...
static Ptr GLgc_101() { /* ret_call_gettype_34 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        GIa1 = (rSp + (Fix) (GIa4))->Val;
        (--rSp)->Val = ((Ptr) GLgc_102);
        {aRet = ((Ptr) GXgettype); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLgc_102() { /* ret_call_gettype_35 */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
        GIa2 = GIa1;
        GIa1 = (rSp++)->Val;
        ...
        (--rSp)->Val = rA4;
        (--rSp)->Val = ((Ptr) GLgc_103);
        {aRet = ((Ptr) GXgetbi); goto lRet;}
  lRet: GIsp = rSp; GIa4 = rA4; return (aRet);}}

static Ptr GLgc_103() { /* ret_call_getbi_36 */
   {    register Ptr aRet, rSp, rA1, rA3, rA4;
        rSp = GIsp; rA1 = GIa1; rA3 = GIa3; rA4 = GIa4;
        rA4 = (rSp++)->Val;
...
extern Ptr GXstrctacc() {       /* structaccess */
   {    register Ptr aRet, rSp, rA1, rA2, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA4 = GIa4;
        if (rA4 != (Ptr) 5)     {aRet = ((Ptr) GLgc_104); goto lRet;}
        rA1 = (rSp + (Fix) 2)->Val;
        if ((rA1 < GIbvect) || (rA1 >= GIbstrg))        {aRet = ((Ptr) GLgc_105); goto lRet;}
        rA2 = (rSp + (Fix) 4)->Val;
        if ((rA2 < GIbsymb) || (rA2 >= GIbcons))        {aRet = ((Ptr) GLgc_106); goto lRet;}
        rA2 = (rA2 + 3)->Val;
        (--rSp)->Val = rA1;
        (--rSp)->Val = rA4;
...
static Ptr GLgc_107() { /* ret_call_typep_37 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4;
        rA4 = (rSp++)->Val;
        rA2 = (rSp++)->Val;
        if (rA1 == GInil)       {aRet = ((Ptr) GLgc_108); goto lRet;}
        rA3 = (rSp + (Fix) 3)->Val;
        if ((Fix) (rA3) < (Fix) 0)      {aRet = ((Ptr) GLgc_109); goto lRet;}
        rA4 = (rA2->Val + 1)->Val;
        if ((Fix) (rA3) >= (Fix) (rA4)) {aRet = ((Ptr) GLgc_108); goto lRet;}
        rA4 = rSp->Val;
l_fieldn:
...
static Ptr GLgc_108() { /* fieldr4 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLgc_105); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_105() { /* fieldr2 */
   {    register Ptr aRet;
        GIa2 = (GIsp + (Fix) 4)->Val;
        {aRet = ((Ptr) GXerrstc); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_106() { /* fieldr3 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        GIa2 = (GIsp + (Fix) 4)->Val;
...
extern Ptr GXsmpvect() {        /* mapallvector */
   {    register Ptr aRet;
        GIa2 = GIbvect;
        {aRet = ((Ptr) GLgc_110); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_110() { /* smpvect2 */
   {    register Ptr aRet, rSp, rA1, rA2;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2;
        if ((rA2->Val >= GIbvect) && (rA2->Val < GIbstrg))      {aRet = ((Ptr) GLgc_111); goto lRet;}
        if (rA2->Val == GInil)  {aRet = ((Ptr) GLgc_111); goto lRet;}
        (--rSp)->Val = rA2;
        (--rSp)->Val = rA1;
        (--rSp)->Val = ((Ptr) GLgc_112);
        (--rSp)->Val = rA1;
        (--rSp)->Val = rA2;
        GIa4 = (Ptr) 2;
        {aRet = ((Ptr) GXfuncall); goto lRet;}
...
static Ptr GLgc_112() { /* smpvect3 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIa2 = (rSp++)->Val;
        {aRet = ((Ptr) GLgc_111); goto lRet;}
  lRet: GIsp = rSp; return (aRet);}}

static Ptr GLgc_111() { /* smpvect4 */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        rA2 += (Fix) (2);
        if (rA2 < GIbstrg)      {aRet = ((Ptr) GLgc_110); goto lRet;}
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa2 = rA2; return (aRet);}}

extern Ptr GXsmpstrg() {        /* mapallstring */
   {    register Ptr aRet;
        GIa2 = GIbstrg;
        {aRet = ((Ptr) GLgc_113); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLgc_113() { /* smpstrg2 */
   {    register Ptr aRet, rSp, rA1, rA2;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2;
        if ((rA2->Val >= GIbstrg) && (rA2->Val < GIbsymb))      {aRet = ((Ptr) GLgc_114); goto lRet;}
        if (rA2->Val == GInil)  {aRet = ((Ptr) GLgc_114); goto lRet;}
        (--rSp)->Val = rA2;
        (--rSp)->Val = rA1;
        (--rSp)->Val = ((Ptr) GLgc_115);
        (--rSp)->Val = rA1;
        (--rSp)->Val = rA2;
        GIa4 = (Ptr) 2;
        {aRet = ((Ptr) GXfuncall); goto lRet;}
...
static Ptr GLgc_114() { /* smpstrg4 */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        rA2 += (Fix) (2);
        if (rA2 < GIbsymb)      {aRet = ((Ptr) GLgc_113); goto lRet;}
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet: GIa2 = rA2; return (aRet);}}

static Ptr GDgc_116() { /* trace gc */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,0,1,2);
  lRet:  return (aRet);}}

static Ptr GDgc_117() { /* trace gc-before-alarm */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,3,1,4);
  lRet:  return (aRet);}}

static Ptr GDgc_118() { /* trace gcalarm */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,5,1,4);
  lRet:  return (aRet);}}

static Ptr GDgc_119() { /* trace gcinfo */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,6,1,2);
  lRet:  return (aRet);}}

static Ptr GDgc_120() { /* trace tcons */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,7,1,8);
  lRet:  return (aRet);}}

static Ptr GDgc_121() { /* trace tconsmk */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,9,1,10);
  lRet:  return (aRet);}}

static Ptr GDgc_122() { /* trace tconscl */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,11,1,10);
  lRet:  return (aRet);}}

static Ptr GDgc_123() { /* trace tconsp */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,12,1,10);
  lRet:  return (aRet);}}

static Ptr GDgc_124() { /* trace freecons */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,13,1,10);
  lRet:  return (aRet);}}

static Ptr GDgc_125() { /* trace freetree */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,14,1,10);
  lRet:  return (aRet);}}

static Ptr GDgc_126() { /* trace type-of */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,15,1,10);
  lRet:  return (aRet);}}

static Ptr GDgc_127() { /* trace typep */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,16,1,8);
  lRet:  return (aRet);}}

static Ptr GDgc_128() { /* trace subtypep */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,17,1,8);
  lRet:  return (aRet);}}

static Ptr GDgc_129() { /* trace send */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,18,1,2);
  lRet:  return (aRet);}}

static Ptr GDgc_130() { /* trace send-error */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,19,1,8);
  lRet:  return (aRet);}}

static Ptr GDgc_131() { /* trace csend */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,20,1,2);
  lRet:  return (aRet);}}

static Ptr GDgc_132() { /* trace send-super */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,21,1,2);
  lRet:  return (aRet);}}

static Ptr GDgc_133() { /* trace send2 */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,22,1,2);
  lRet:  return (aRet);}}

static Ptr GDgc_134() { /* trace structaccess */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,23,1,2);
  lRet:  return (aRet);}}

static Ptr GDgc_135() { /* trace mapallvector */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,24,1,10);
  lRet:  return (aRet);}}

static Ptr GDgc_136() { /* trace mapallstring */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYgc,25,1,10);
  lRet:  return (aRet);}}
