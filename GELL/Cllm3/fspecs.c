...
static Ptr GLfspecs_1() {       /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_spec); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_spec() {       /* ini_spec */
   {    register Ptr aRet;
...
static Ptr GLfspecs_2() {       /* ret_call_loc_1 */
   {    register Ptr aRet;
        GIa2 = GMcbindn;
        GIa2->Val = GIa1;
...
static Ptr GLfspecs_3() {       /* ret_call_loc_2 */
   {    register Ptr aRet;
        GIa2 = GMctag;
        GIa2->Val = GIa1;
...
static Ptr GLfspecs_4() {       /* ret_call_loc_3 */
   {    register Ptr aRet;
        GIa2 = GMcprot;
        GIa2->Val = GIa1;
...
static Ptr GLfspecs_5() {       /* ret_call_loc_4 */
   {    register Ptr aRet;
        GIa2 = GMcmplock;
        GIa2->Val = GIa1;
...
static Ptr GLfspecs_6() {       /* ret_call_loc_5 */
   {    register Ptr aRet;
        GIa2 = GMddlink;
        GIa2->Val = GIa1;
...
static Ptr GLfspecs_7() {       /* ret_call_loc_6 */
   {    register Ptr aRet;
        GIa2 = GMdllink;
        GIa2->Val = GIa1;
...
static Ptr GLfspecs_8() {       /* ret_call_loc_7 */
   {    register Ptr aRet;
        GIa2 = GMditcnt;
        GIa2->Val = GIa1;
        GIcpkgc = GMllsystem;
...
extern Ptr GXschedule() {       /* schedule */
...
static Ptr GLfspecs_15() {      /* ret_call_sus100_8 */
...
static Ptr GLfspecs_17() {      /* susb13 */
   {    register Ptr aRet;
        GIa4 = ((Ptr) GXunbind1);
        {aRet = ((Ptr) GLfspecs_10); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLfspecs_16() {      /* sus100 */
...
static Ptr GLfspecs_19() {      /* ret_call_sus100_9 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        {register Ptr aux;
                aux = rSp->Val;
...
static Ptr GLfspecs_20() {      /* ret_call_sus100_10 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa3 = (rSp++)->Val;
...
static Ptr GLfspecs_12() {      /* susb10 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
        {aRet = ((Ptr) GLfspecs_10); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLfspecs_13() {      /* susb4 */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        GIa3 = (rSp++)->Val;
        rA2 = (rSp++)->Val;
...
static Ptr GLfspecs_28() {      /* ret_call_deset_11 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        (--rSp)->Val = GIdlink;
...
static Ptr GLfspecs_33() {      /* ret_call_evala1_12 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
        {aRet = ((Ptr) GLfspecs_32); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLfspecs_32() {      /* tagbd3 */
   {    register Ptr aRet;
        GIa2 = (GIa2 + 1)->Val;
        {aRet = ((Ptr) GLfspecs_30); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLfspecs_30() {      /* tagbd4 */
   {    register Ptr aRet;
        if ((long) GIa2 >= (long) GIbcons)      {aRet = ((Ptr) GLfspecs_31); goto lRet;}
        {aRet = ((Ptr) GLfspecs_29); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLfspecs_29() {      /* tagbdr */
   {    register Ptr aRet;
        GIa1 = GInil;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}
...
static Ptr GLfspecs_36() {      /* blckerr */
   {    register Ptr aRet;
        GIa1 = GIa2;
        GIa2 = GMblock;
...
extern Ptr GXllretf() { /* return-from */
...
static Ptr GLfspecs_37() {      /* llretf1 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLfspecs_38);
        {aRet = ((Ptr) GXevprogn); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLfspecs_38() {      /* ret_call_evprogn_13 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
        {aRet = ((Ptr) GLfspecs_39); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLfspecs_39() {      /* llretg */
...
static Ptr GLfspecs_40() {      /* llretr3 */
...
static Ptr GLfspecs_41() {      /* cbindnc */
   {    register Ptr aRet, rA2;
        rA2 = GIa2;
        GIintret = (GIsp++)->Val;
l_cbindnn:
...
extern Ptr GXcprot() {  /* prot */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXsysprot); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXcmplock() {        /* lock */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
        (--rSp)->Val = GIa1;
...
extern Ptr GXcsched() { /* #:gell:schedule */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        if (rSp < GImstack)     {aRet = ((Ptr) GXerrfs); goto lRet;}
        GIa2 = (rSp++)->Val;
...
extern Ptr GXcblock() { /* #:gell:block */
   {    register Ptr aRet, rSp, rA1, rA2, rA3;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3;
        rA2 = rA1;
        rA1 = (rSp++)->Val;
...
extern Ptr GXcexit() {  /* exit */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXfindtag); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXcretfr() { /* retfrom */
   {    register Ptr aRet;
        {aRet = ((Ptr) GLfspecs_39); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXcgo() {    /* #:gell:go */
   {    register Ptr aRet;
        {aRet = ((Ptr) GLfspecs_34); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXctagbody() {       /* #:gell:tagbody */
   {    register Ptr aRet, rSp, rA2;
        rSp = GIsp; rA2 = GIa2;
        GIa1 = (rSp++)->Val;
        rA2 = (Ptr) 0;
...
extern Ptr GXcffuncall() {      /* ffuncall */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXffuncall); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXcwithit() {        /* with-interrupts */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        (--rSp)->Val = GIitstate;
...
static Ptr GLfspecs_43() {      /* ret_call_sysprot_14 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIitstate = (rSp++)->Val;
...
static Ptr GLfspecs_42() {      /* cwithit1 */
   {    register Ptr aRet;
        GIitstate = (Ptr) 1;
        {aRet = GIa1; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXcwithnoit() {      /* without-interrupts */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        (--rSp)->Val = GIitstate;
...
static Ptr GLfspecs_45() {      /* ret_call_sysprot_15 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIitstate = (rSp++)->Val;
...
static Ptr GLfspecs_44() {      /* cwithno1 */
   {    register Ptr aRet;
        GIitstate = (Ptr) 0;
        {aRet = GIa1; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXfibd() {   /* fibd */
   {    register Ptr aRet, rA3;
        rA3 = GIa3;
        rA3 = GMnvar;
        rA3 = (rA3 + 4)->Val;
...
static Ptr GLfspecs_46() {      /* ret_call_cbind1_16 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLfspecs_47() {      /* ret_call_fibd_17 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = rA1;
        rA1 = GMnvar;
...
static Ptr GLfspecs_48() {      /* ret_call_fibd_18 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
...
static Ptr GLfspecs_49() {      /* ret_call_fibl_19 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = rA1;
        rA1 = (rSp + (Fix) 1)->Val;
...
static Ptr GLfspecs_50() {      /* ret_call_fibl_20 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
        GIa1 = (Ptr) ((UFix) ((Fix) (GIa1) + (Fix) (GIa2)));
...
static Ptr GLfspecs_52() {      /* ret_call_fibml_21 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        {register Ptr aux;
                aux = rSp->Val;
...
static Ptr GLfspecs_53() {      /* ret_call_fibml_22 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
        GIa1 = (Ptr) ((UFix) ((Fix) (GIa1) + (Fix) (GIa2)));
...
static Ptr GDfspecs_81() {      /* trace fibd */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYfspecs,31,1,6);
  lRet:  return (aRet);}}

static Ptr GDfspecs_82() {      /* trace fibl */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYfspecs,32,1,6);
  lRet:  return (aRet);}}

static Ptr GDfspecs_83() {      /* trace fibml */
   {    register Ptr aRet;
        aRet = llrt_jmpd (GYfspecs,33,1,6);
  lRet:  return (aRet);}}
