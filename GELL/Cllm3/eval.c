...
static Ptr GLeval_1() { /* startmodule */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXini_eval); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXini_eval() {       /* ini_eval */
   {    register Ptr aRet;
        GIcpkgc = GMsyspkgc;
...
static Ptr GLeval_2() { /* ret_call_sysprot_1 */
...
extern Ptr GXevalwhen() {       /* eval-when */
...
static Ptr GLeval_4() { /* ret_call_llarget_2 */
...
extern Ptr GXtraceval() {       /* traceval */
...
extern Ptr GXstepeval() {       /* stepeval */
   {    register Ptr aRet, rSp, rA1, rA2, rA4;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA4 = GIa4;
...
static Ptr GLeval_6() { /* ret_call_probj_3 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp + 1)->Val;
...
static Ptr GLeval_7() { /* ret_call_probjt_4 */
   {    register Ptr aRet;
        GIa4 = (Ptr) 2;
        {aRet = ((Ptr) GXtraceval); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_5() { /* stepevr */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIa1;
        GIa1 = GMlarrow;
...
static Ptr GLeval_8() { /* ret_call_probj_5 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = rSp->Val;
...
static Ptr GLeval_9() { /* ret_call_probjt_6 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLeval_10() {        /* ret_call_llitsoft_7 */
   {    register Ptr aRet;
        GIevalst = GMt;
        {aRet = (GIsp++)->Val; goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXevalcar() {        /* evalcar */
   {    register Ptr aRet;
        GIa1 = GIa1->Val;
...
extern Ptr GXevala1() { /* evala1 */
   {    register Ptr aRet;
        if (GIevalst != GInil)  {aRet = ((Ptr) GXevalt); goto lRet;}
        {aRet = ((Ptr) GXevalan); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXevalan() { /* evalan */
...
static Ptr GLeval_27() {        /* ret_call_getfns_8 */
   {    register Ptr aRet;
...
static Ptr GLeval_14() {        /* eval0 */
   {    register Ptr aRet;
        if (GIa1 != GInil)      {aRet = ((Ptr) GLeval_28); goto lRet;}
        {aRet = GIa3; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_15() {        /* eval1 */
...
static Ptr GLeval_34() {        /* ret_call_evalcar_9 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        {register Ptr aux;
                aux = rSp->Val;
...
static Ptr GLeval_35() {        /* ret_call_evala1_10 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = GIa1;
        GIa1 = (rSp++)->Val;
...
static Ptr GLeval_37() {        /* ret_call_evalcar_11 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIa2 = (rSp++)->Val;
        {register Ptr aux;
...
static Ptr GLeval_38() {        /* ret_call_evalcar_12 */
...
static Ptr GLeval_40() {        /* ret_call_evalcar_13 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa3 = GIa1;
        GIa2 = (rSp++)->Val;
...
static Ptr GLeval_44() {        /* ret_call_evalcar_14 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        {register Ptr aux;
                aux = rSp->Val;
...
static Ptr GLeval_45() {        /* ret_call_evalcar_15 */
...
static Ptr GLeval_47() {        /* ret_call_evalcar_16 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        {register Ptr aux;
                aux = rSp->Val;
...
static Ptr GLeval_46() {        /* evalnsn */
   {    register Ptr aRet;
        GIa4 = (Ptr) 1;
        {aRet = ((Ptr) GLeval_48); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_48() {        /* evaln1 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = (rA1 + 1)->Val;
        (--rSp)->Val = GIa4;
...
static Ptr GLeval_49() {        /* ret_call_evalcar_17 */
   {    register Ptr aRet, rSp, rA1, rA4;
        rSp = GIsp; rA1 = GIa1; rA4 = GIa4;
        GIa3 = (rSp++)->Val;
        rA4 = (rSp++)->Val;
...
static Ptr GLeval_43() {        /* evbal2 */
   {    register Ptr aRet;
        (--GIsp)->Val = GIa2;
        {aRet = ((Ptr) GLeval_50); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_41() {        /* evbal */
   {    register Ptr aRet;
        (--GIsp)->Val = GIa1;
        {aRet = ((Ptr) GLeval_50); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_50() {        /* evbal1 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GXevbale); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXevbale() { /* evbale */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLeval_51);
        {aRet = ((Ptr) GXfindfn); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_51() {        /* ret_call_findfn_18 */
   {    register Ptr aRet;
        GIa2 = GIa1;
        GIa1 = (GIsp++)->Val;
...
static Ptr GLeval_19() {        /* evalf */
   {    register Ptr aRet;
        {aRet = GIa3; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_24() {        /* evalm */
   {    register Ptr aRet;
...
static Ptr GLeval_53() {        /* ret_call_displace_19 */
   {    register Ptr aRet;
        if (GIevalst != GInil)  {aRet = ((Ptr) GXevalt); goto lRet;}
        {aRet = ((Ptr) GXevalan); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_20() {        /* evexp */
   {    register Ptr aRet;
        GIa4 = (Ptr) 0;
...
static Ptr GLeval_56() {        /* ret_call_evalcar_20 */
   {    register Ptr aRet, rSp, rA1, rA4;
        rSp = GIsp; rA1 = GIa1; rA4 = GIa4;
        GIa2 = (rSp++)->Val;
        GIa3 = (rSp++)->Val;
...
extern Ptr GXevbndext() {       /* evbndext */
   {    register Ptr aRet;
        if ((long) GIa3 >= (long) GIbcons)      {aRet = ((Ptr) GLeval_59); goto lRet;}
        {aRet = ((Ptr) GLeval_58); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_58() {        /* evbnd6 */
...
static Ptr GLeval_60() {        /* evbnr32 */
   {    register Ptr aRet;
        GIa4 = GIsavea4;
        {aRet = ((Ptr) GLeval_66); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_66() {        /* evbnr33 */
   {    register Ptr aRet;
        GIa1 = GIsavea2;
...
static Ptr GLeval_69() {        /* ret_call_evbdst1_24 */
...
static Ptr GLeval_73() {        /* ret_call_evbdst1_25 */
   {    register Ptr aRet;
        GIa3 = (GIsp++)->Val;
        {aRet = ((Ptr) GLeval_72); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXevexpg() { /* evexpg */
...
extern Ptr GXevprognr() {       /* evprognr */
...
static Ptr GLeval_76() {        /* evprogn5 */
   {    register Ptr aRet;
        GIa1 = GIa2;
        {aRet = ((Ptr) GLeval_77); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_77() {        /* evprogn6 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXerrbal);
        {aRet = ((Ptr) GLeval_67); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_74() {        /* evprogn7 */
   {    register Ptr aRet;
        if (GIa1 == GInil)      { aRet = (GIsp++)->Val; goto lRet;}
        {aRet = ((Ptr) GLeval_77); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_22() {        /* evmac */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GXevala1);
        GIa1 = GIforme;
...
static Ptr GLeval_21() {        /* evfexp */
   {    register Ptr aRet;
        GIerrname = GIa2;
        {aRet = ((Ptr) GLeval_78); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_78() {        /* bndtrb */
   {    register Ptr aRet, rA3;
        rA3 = GIa3;
        GIintret = ((Ptr) GXevexpg);
        GIsavea1 = rA3;
...
extern Ptr GXbndtrbex() {       /* bndtrbex */
   {    register Ptr aRet;
        GIa4 = (Ptr) 0;
        {aRet = ((Ptr) GLeval_79); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_80() {        /* bndtrb1 */
   {    register Ptr aRet, rA1, rA2, rA3, rBcons;
        rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rBcons = GIbcons;
...
static Ptr GLeval_82() {        /* ret_call_evbdst1_28 */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rNil, rBcons;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rNil = GInil; rBcons = GIbcons;
        GIa4 = GIsavea4;
        rA2 = rNil;
...
static Ptr GLeval_86() {        /* ret_call_verlpar_29 */
   {    register Ptr aRet;
        GIa2 = GMlambda;
        GIa4 = (Ptr) 0;
...
static Ptr GLeval_90() {        /* ret_call_evalcar_30 */
...
static Ptr GLeval_92() {        /* ret_call_gettype_33 */
   {    register Ptr aRet, rSp, rA1, rNil;
        rSp = GIsp; rA1 = GIa1; rNil = GInil;
...
static Ptr GLeval_93() {        /* ret_call_getfns_34 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
...
static Ptr GLeval_94() {        /* ret_call_errudf_35 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIa2 = rA1;
        rA1 = (GIsp++)->Val;
...
static Ptr GLeval_95() {        /* xwnaer0 */
   {    register Ptr aRet;
        GIa2 = GIa1;
        {aRet = ((Ptr) GLeval_96); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_28() {        /* wnaer0 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLeval_96() {        /* wnaer00 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 0;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_97() {        /* xwnaer1 */
   {    register Ptr aRet;
        GIa2 = GIa1;
        {aRet = ((Ptr) GLeval_98); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_30() {        /* wnaer1d */
   {    register Ptr aRet;
        GIa1 = (GIa1 + 1)->Val;
        {aRet = ((Ptr) GLeval_29); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_29() {        /* wnaer1 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLeval_98() {        /* wnaer10 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 1;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_99() {        /* xwnaer2 */
   {    register Ptr aRet;
        GIa2 = GIa1;
        {aRet = ((Ptr) GLeval_100); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_33() {        /* wnaer23d */
   {    register Ptr aRet;
        GIa3 = (GIa3 + 1)->Val;
        {aRet = ((Ptr) GLeval_32); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_32() {        /* wnaer23 */
   {    register Ptr aRet;
        GIa1 = GIa3;
        {aRet = ((Ptr) GLeval_31); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_31() {        /* wnaer2 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLeval_100() {       /* wnaer20 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 2;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_101() {       /* xwnaer3 */
   {    register Ptr aRet;
        GIa2 = GIa1;
        {aRet = ((Ptr) GLeval_102); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_39() {        /* wnaer3d */
   {    register Ptr aRet;
        GIa1 = (GIa1 + 1)->Val;
        {aRet = ((Ptr) GLeval_36); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_36() {        /* wnaer3 */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
...
static Ptr GLeval_102() {       /* wnaer30 */
   {    register Ptr aRet;
        GIa1 = (Ptr) 3;
        {aRet = ((Ptr) GXerrwna); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXfuncall() {        /* funcall */
   {    register Ptr aRet;
        GIerrname = GMfuncall;
...
static Ptr GLeval_104() {       /* funcall0 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
        rA4 = (Ptr) ((UFix) ((Fix) (rA4) - (Fix) (1)));
...
extern Ptr GXffuncall() {       /* ffuncall */
   {    register Ptr aRet, rA1;
        rA1 = GIa1;
        GIintllink = GInil;
...
static Ptr GLeval_103() {       /* funcerwn */
   {    register Ptr aRet;
        GIa1 = GIa4;
        (--GIsp)->Val = ((Ptr) GXerrwna);
        {aRet = ((Ptr) GLeval_67); goto lRet;}
...
static Ptr GLeval_119() {       /* ret_call_ferrnam_37 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLeval_120);
        {aRet = ((Ptr) GXerrudf); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_120() {       /* ret_call_errudf_38 */
   {    register Ptr aRet;
        GIa4 = (GIsp++)->Val;
        {aRet = ((Ptr) GXffuncall); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_108() {       /* fncal0 */
   {    register Ptr aRet;
        if (GIa4 != (Ptr) 0)    {aRet = ((Ptr) GLeval_95); goto lRet;}
        {aRet = (GIa1 + 2)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_109() {       /* fncal1 */
   {    register Ptr aRet, rA4;
        rA4 = GIa4;
...
static Ptr GLeval_112() {       /* fncaln */
   {    register Ptr aRet;
        {aRet = (GIa1 + 2)->Val; goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_113() {       /* fncalf */
...
extern Ptr GXunbind0() {        /* unbind0 */
   {    register Ptr aRet;
        {aRet = ((Ptr) GXerres); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXunbind1() {        /* unbind1 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GXunbinp1); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXunbinp1() {        /* unbinp1 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIsavea3 = GIa3;
        GIdlink = (rSp++)->Val;
...
static Ptr GLeval_134() {       /* ret_call_unbides1_40 */
   {    register Ptr aRet;
        GIa3 = (GIsp++)->Val;
        GIa4 = (Ptr) ((UFix) ((Fix) (GIa4) - (Fix) (1)));
        {aRet = ((Ptr) GLeval_130); goto lRet;}
...
static Ptr GLeval_136() {       /* unbides0 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLeval_137);
        {aRet = ((Ptr) GLeval_135); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_135() {       /* unbides1 */
   {    register Ptr aRet, rSp, rA2, rA3;
        rSp = GIsp; rA2 = GIa2; rA3 = GIa3;
...
static Ptr GLeval_137() {       /* unbides2 */
   {    register Ptr aRet, rSp, rA2, rA3;
        rSp = GIsp; rA2 = GIa2; rA3 = GIa3;
        rA2 = (rSp++)->Val;
...
extern Ptr GXunbind2() {        /* unbind2 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLeval_121); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_121() {       /* unbinp2 */
...
extern Ptr GXunbind4() {        /* unbind4 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLeval_123); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_123() {       /* unbinp4 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIdlink = (rSp++)->Val;
        GIllink = (rSp++)->Val;
...
extern Ptr GXunbind5() {        /* unbind5 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLeval_124); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_124() {       /* unbinp5 */
   {    register Ptr aRet, rSp, rA1, rA2, rNil;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rNil = GInil;
        GIdlink = (rSp++)->Val;
        GIa4 = (rSp++)->Val;
...
static Ptr GLeval_138() {       /* ret_call_apply_41 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
extern Ptr GXunbind6() {        /* unbind6 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLeval_125); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_125() {       /* unbinp6 */
   {    register Ptr aRet, rSp, rA3;
        rSp = GIsp; rA3 = GIa3;
        GIdlink = (rSp++)->Val;
        {register Ptr aux;
...
static Ptr GLeval_139() {       /* ret_call_evprogn_42 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = (rSp++)->Val;
        GIa2 = (rSp++)->Val;
...
extern Ptr GXunbind7() {        /* unbind7 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLeval_126); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_126() {       /* unbinp7 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        GIdlink = (rSp++)->Val;
        {register Ptr aux;
...
extern Ptr GXunbind9() {        /* unbind9 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLeval_128); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_128() {       /* unbinp9 */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
        GIdlink = rSp->Val;
        rA4 = GIllink;
...
extern Ptr GXunbind10() {       /* unbind10 */
   {    register Ptr aRet;
        GIa3 = ((Ptr) GXpopj0);
        {aRet = ((Ptr) GLeval_129); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_129() {       /* unbinp10 */
   {    register Ptr aRet, rSp, rA4;
        rSp = GIsp; rA4 = GIa4;
        GIdlink = rSp->Val;
        rA4 = GIllink;
...
static Ptr GLeval_140() {       /* ret_call_evalcar_43 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        {register Ptr aux;
                aux = rSp->Val;
...
static Ptr GLeval_141() {       /* ret_call_evalcar_44 */
   {    register Ptr aRet;
        GIerrname = GMletv;
        {aRet = ((Ptr) GLeval_142); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_142() {       /* letvq2 */
   {    register Ptr aRet, rSp, rA3;
        rSp = GIsp; rA3 = GIa3;
        rA3 = (rSp++)->Val;
        GIa2 = (rSp++)->Val;
...
static Ptr GLeval_143() {       /* ret_call_evalcar_46 */
   {    register Ptr aRet;
        GIerrname = GMletvq;
        {aRet = ((Ptr) GLeval_142); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXflet() {   /* flet */
   {    register Ptr aRet, rSp, rA1, rA2, rA3, rA4, rBcons;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rA3 = GIa3; rA4 = GIa4; rBcons = GIbcons;
...
extern Ptr GXtag() {    /* tag */
   {    register Ptr aRet;
        (--GIsp)->Val = GIa1->Val;
        {aRet = ((Ptr) GLeval_144); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_144() {       /* tag3 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        (--rSp)->Val = GIdlink;
...
static Ptr GLeval_145() {       /* ret_call_evalcar_47 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
...
static Ptr GLeval_146() {       /* ret_call_evalcar_48 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        {register Ptr aux;
                aux = rSp->Val;
...
extern Ptr GXuntlxit() {        /* untilexit */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = rA1->Val;
        (--rSp)->Val = GIdlink;
...
static Ptr GLeval_148() {       /* untlxit1 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa1 = rSp->Val;
        GIerrname = GMuntlxit;
...
static Ptr GLeval_147() {       /* exit1 */
   {    register Ptr aRet;
        (--GIsp)->Val = ((Ptr) GLeval_149);
        {aRet = ((Ptr) GXevprogn); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_149() {       /* ret_call_evprogn_50 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
        {aRet = ((Ptr) GXfindtag); goto lRet;}
  lRet:  return (aRet);}}

extern Ptr GXfindtag() {        /* findtag */
   {    register Ptr aRet, rSp, rA2, rA3;
        rSp = GIsp; rA2 = GIa2; rA3 = GIa3;
l_GXfindtag:
        rSp = GIdlink;
...
l_uvesc4:
        ...
        GIsp = rSp; GIa1 = rA1; GIa2 = rA2; GIa3 = rA3; rA2 = llrt_cons (rA1, rA2);
        GIdlink = (rSp++)->Val;
        rA1 = (rSp++)->Val;
        {aRet = ((Ptr) GXapply); goto lRet;}
  lRet: GIsp = rSp; GIa1 = rA1; GIa2 = rA2; GIa3 = rA3; return (aRet);}}

extern Ptr GXunwind() { /* unwind */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = (rA1 + 1)->Val;
...
static Ptr GLeval_151() {       /* ret_call_evalcar_51 */
   {    register Ptr aRet;
        GIa2 = (GIsp++)->Val;
...
extern Ptr GXllitsoft() {       /* llitsoft */
   {    register Ptr aRet, rA3;
        rA3 = GIa3;
        rA3 = GMsysits;
        rA3 = rA3->Val;
...
static Ptr GLeval_154() {       /* llitsofi */
   {    register Ptr aRet, rSp, rA1, rA2, rNil;
        rSp = GIsp; rA1 = GIa1; rA2 = GIa2; rNil = GInil;
        (--rSp)->Val = rA2;
        (--rSp)->Val = GIsavea4;
...
static Ptr GLeval_156() {       /* ret_call_findits_52 */
   {    register Ptr aRet;
...
static Ptr GLeval_155() {       /* llitster */
   {    register Ptr aRet;
        GIa1 = GIa2;
        GIa2 = GMitsoft;
        GIa3 = GMsysits;
...
static Ptr GLeval_158() {       /* findits0 */
   {    register Ptr aRet;
        GIa1 = (GIsp++)->Val;
        {aRet = ((Ptr) GLeval_157); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_157() {       /* findits */
...
static Ptr GLeval_160() {       /* ret_call_getfns_53 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLeval_159() {       /* findits1 */
   {    register Ptr aRet, rSp, rA1;
        rSp = GIsp; rA1 = GIa1;
        (--rSp)->Val = (rA1 + 1)->Val;
        rA1 = rA1->Val;
...
static Ptr GLeval_161() {       /* ret_call_getfn1_54 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa2 = (rSp++)->Val;
...
static Ptr GLeval_162() {       /* ret_call_evalcar_55 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        {register Ptr aux;
                aux = rSp->Val;
...
extern Ptr GXfunction() {       /* function */
   {    register Ptr aRet, rSp, rA1, rBcons;
        rSp = GIsp; rA1 = GIa1; rBcons = GIbcons;
...
static Ptr GLeval_164() {       /* ret_call_verlpar4_56 */
   {    register Ptr aRet, rSp;
        rSp = GIsp;
        GIa3 = (rSp++)->Val;
        {aRet = (rSp++)->Val; goto lRet;}
...
static Ptr GLeval_166() {       /* verlpar3 */
   {    register Ptr aRet, rSp, rA3;
        rSp = GIsp; rA3 = GIa3;
        (--rSp)->Val = (rA3 + 1)->Val;
        rA3 = rA3->Val;
...
static Ptr GLeval_167() {       /* ret_call_verlpar5_57 */
   {    register Ptr aRet;
        GIa3 = (GIsp++)->Val;
        {aRet = ((Ptr) GLeval_165); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_165() {       /* verlpar4 */
   {    register Ptr aRet;
        if (GIa3 == GInil)      { aRet = (GIsp++)->Val; goto lRet;}
        {aRet = ((Ptr) GLeval_168); goto lRet;}
  lRet:  return (aRet);}}

static Ptr GLeval_168() {       /* verlpar5 */
...
static Ptr GLeval_169() {       /* ret_call_findfn_59 */
